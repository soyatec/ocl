...
For the Pivot evaluator, all evaluations are performed using polymorphic @Value@ s, whereas for the classic evaluator evaluations were performed on naked types such as Integer, String, Set and EObject.
