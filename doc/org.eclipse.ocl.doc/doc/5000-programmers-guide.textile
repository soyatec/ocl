h1(#ProgrammersGuide). Classic Ecore/UML Programmers Guide
...
will become the preferred binding in 4.2.0 (Luna). The Pivot binding is described in a separate "Pivot Programmers Guide":#PivotProgrammersGuide.
