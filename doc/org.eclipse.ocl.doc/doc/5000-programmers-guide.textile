h1(#ProgrammersGuide). Ecore/UML Programmers Guide
...
will become the preferred binding in 4.1.0 (Kepler). The Pivot binding is described in a separate "Pivot Programmers Guide":#PivotProgrammersGuide.
