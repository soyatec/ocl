...
"@Query@":http://download.eclipse.org/modeling/mdt/ocl/javadoc/4.0.0/org/eclipse/ocl/examples/pivot/Query.html
objects for evaluating constraints and query expressions.

!images/5115-query.png(OCL Query API)!

The @Query@ encapsulates an
"@EvaluationEnvironment@":http://download.eclipse.org/modeling/mdt/ocl/javadoc/4.0.0/org/eclipse/ocl/examples/pivot/EvaluationEnvironment.html
...
"@OCL.setExtentMap()@":http://download.eclipse.org/modeling/mdt/ocl/javadoc/4.0.0/org/eclipse/ocl/examples/pivot/OCL.html#setExtentMap(java.util.Map)
...
!images/6315-check-all.png(Evaluating all Constraints)!
...
!images/6315-check-one.png(Evaluating one Constraint)!
...
!images/6315-check-quick.png(Evaluating Constraints Quicker)!
