...
The Complete OCL syntax is defined by the OMG OCL 2.3.1 specification.
...
The import, include and library declarations are Eclipse OCL extensions. The OCL 2.3.1 specification provides no mechanism for a Complete OCL document to reference external material.
