...
In the Kepler (4.1) release, the code generator has been substantially improved and a number of internal APIs have evolved accordingly. UML support has been improved to facilitate usage within Papyrus, and extensibility has been improved fpor use by QVTd.
