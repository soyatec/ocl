...
The Kepler release supports Complete OCL compleemnts in Papyrus and OCLinEcore.
...
At the time of writing, just before Kepler, the underlying Papyrus problem has been cured but a minor problem remains. It is noit clear whether this will be fixed in Papyrus 0.10.0.
