...
The Kepler release supports Complete OCL complements in Papyrus and OCLinEcore.

The *OCL->Load Document* menu action activates the *Load Complete OCL Document* dialog in which you can browse the File system or Workspace for one or more Complete OCL documents to load, or often more conveniently you can just Drag and Drop them from an Operating System Explorer or an Eclipse Explorer.
