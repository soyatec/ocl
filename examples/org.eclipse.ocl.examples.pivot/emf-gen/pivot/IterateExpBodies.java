...

{
    ...
    public static class _invariant_TypeIsResultType extends AbstractUnaryOperation
    {
        ...
        public @Nullable Object evaluate(final @NonNull DomainEvaluator evaluator, final @NonNull TypeId returnTypeId, final @Nullable Object self) throws Exception {
            ...
            final @Nullable Variable result_1 = ((IterateExp)self).getResult();
            if (result_1 == null) throw new InvalidValueException("Non-Null source for property");
            final @Nullable DomainType type_0 = result_1.getType();
            if (self == null) throw new InvalidValueException("Non-Null source for property");
    ...
    public static class _invariant_BodyTypeConformsToResultType extends AbstractUnaryOperation
    {
        ...
        public @Nullable Object evaluate(final @NonNull DomainEvaluator evaluator, final @NonNull TypeId returnTypeId, final @Nullable Object self) throws Exception {
            ...
            final @NonNull Boolean result = OclTypeConformsToOperation.INSTANCE.evaluate(evaluator, TypeId.BOOLEAN, type, type_0);
            return result;
        }
    }
    /**
    ...
    public static class _invariant_OneInitializer extends AbstractUnaryOperation
    {
        ...
        public @Nullable Object evaluate(final @NonNull DomainEvaluator evaluator, final @NonNull TypeId returnTypeId, final @Nullable Object self) throws Exception {
            ...
            final @Nullable Variable result_1 = ((IterateExp)self).getResult();
            if (result_1 == null) throw new InvalidValueException("Non-Null source for property");
            final @Nullable OCLExpression initExpression = result_1.getInitExpression();
            ...
            final @NonNull Boolean result = OclAnyEqualOperation.INSTANCE.evaluate(evaluator, TypeId.BOOLEAN, size, INT_1);
            return result;
        }
    }
}
