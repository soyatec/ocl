...

{
    ...
    public static class _invariant_TypeIsInType extends AbstractUnaryOperation
    {
        ...
        public @Nullable Object evaluate(final @NonNull DomainEvaluator evaluator, final @NonNull TypeId returnTypeId, final @Nullable Object self) throws Exception {
            ...
            final @Nullable OCLExpression in = ((LetExp)self).getIn();
            if (in == null) throw new InvalidValueException("Non-Null source for property");
            final @Nullable DomainType type_0 = in.getType();
            if (self == null) throw new InvalidValueException("Non-Null source for property");
