...
public class IfExpBodies extends ValuesUtil

{
    ...
    {
        public static final @NonNull _invariant_ConditionTypeIsBoolean INSTANCE = new _invariant_ConditionTypeIsBoolean();
        ...
        public @Nullable Object evaluate(final @NonNull DomainEvaluator evaluator, final @NonNull TypeId returnTypeId, final @Nullable Object self) throws Exception {
            ...
            final @Nullable OCLExpression condition = ((IfExp)self).getCondition();
            if (condition == null) throw new InvalidValueException("Non-Null source for property");
            final @Nullable DomainType type = condition.getType();
