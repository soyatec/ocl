...
public class LetExpImpl
	...
	public boolean validateTypeIsInType(DiagnosticChain diagnostics, Map<Object, Object> context)
	{
		...
		*/
		try {
			...
			final @NonNull Value result = LetExpBodies._invariant_TypeIsInType.INSTANCE.evaluate(evaluator, returnType, self);
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd,
		...
		switch (featureID)
		{
			...
			case PivotPackage.LET_EXP__APPLIED_STEREOTYPE:
