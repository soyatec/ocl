	...
	public static class _invariant_TypeIsBoolean extends AbstractUnaryOperation
	{
		...
		*/
		public @NonNull Object evaluate(@NonNull DomainEvaluator evaluator, @NonNull TypeId returnTypeId, final @NonNull Object self) throws InvalidValueException {
			...
			DomainType static_A_symbol__1 = evaluator.getStaticTypeOf(A_symbol_, T_Metaclass_Boolean_);
			...
			Object A_symbol__1 = dynamic_A_symbol__1.evaluate(evaluator, T_Boolean.getTypeId(), A_symbol_, T_Metaclass_Boolean_);
			return A_symbol__1;
		}
	}
