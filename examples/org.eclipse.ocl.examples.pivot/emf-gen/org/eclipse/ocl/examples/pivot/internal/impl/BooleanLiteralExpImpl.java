...
public class BooleanLiteralExpImpl
	...
	public boolean validateTypeIsBoolean(DiagnosticChain diagnostics, Map<Object, Object> context)
	{
		...
		*/
		try {
			...
			final @NonNull Value result = BooleanLiteralExpBodies._invariant_TypeIsBoolean.INSTANCE.evaluate(evaluator, returnType, self);
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID)
		{
			...
			case PivotPackage.BOOLEAN_LITERAL_EXP__APPLIED_STEREOTYPE:
