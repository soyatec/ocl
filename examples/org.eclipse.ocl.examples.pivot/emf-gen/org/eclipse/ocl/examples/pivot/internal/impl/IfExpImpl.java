...
public class IfExpImpl
	...
	public boolean validateConditionTypeIsBoolean(DiagnosticChain diagnostics, Map<Object, Object> context)
	{
		...
		*/
		try {
			...
			final @NonNull Value result = IfExpBodies._invariant_ConditionTypeIsBoolean.INSTANCE.evaluate(evaluator, returnType, self);
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd,
		...
		switch (featureID)
		{
			...
			case PivotPackage.IF_EXP__APPLIED_STEREOTYPE:
