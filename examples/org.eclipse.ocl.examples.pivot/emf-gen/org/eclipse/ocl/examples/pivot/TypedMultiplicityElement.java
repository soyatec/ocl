...
public interface TypedMultiplicityElement
	 ...
	 * <!-- end-user-doc -->
	 * @model required="true"
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel body='/*\nParameter{name = \'name\'}\n\052/\ntry {\n\tfinal @<%org.eclipse.jdt.annotation.NonNull%> <%org.eclipse.ocl.examples.domain.evaluation.DomainEvaluator%> evaluator = new <%org.eclipse.ocl.examples.library.ecore.EcoreExecutorManager%>(this, null, <%org.eclipse.ocl.examples.pivot.PivotTables%>.LIBRARY);\n\tfinal @NonNull <%org.eclipse.ocl.examples.domain.values.ValueFactory%> valueFactory = evaluator.getValueFactory();\n\tfinal @NonNull Object self = valueFactory.valueOf(this);\n\tfinal @NonNull <%org.eclipse.ocl.examples.library.executor.ExecutorType%> T_pivot__Parameter = <%org.eclipse.ocl.examples.pivot.PivotTables%>.Types._Parameter;\n\t\n\tfinal @NonNull <%org.eclipse.ocl.examples.domain.elements.DomainType%> returnType = T_pivot__Parameter;\n\tfinal @NonNull Object result = <%org.eclipse.ocl.examples.pivot.bodies.TypedMultiplicityElementBodies%>._makeParameter_body_.INSTANCE.evaluate(evaluator, returnType, self);\n\treturn (Parameter) <%org.eclipse.ocl.examples.domain.values.util.ValuesUtil%>.asEcoreObject(result);\n} catch (<%org.eclipse.ocl.examples.domain.evaluation.InvalidValueException%> e) {\n\tthrow new <%org.eclipse.emf.common.util.WrappedException%>(\"Failed to evaluate org.eclipse.ocl.examples.pivot.bodies.TypedMultiplicityElementBodies\", e);\n}\n'"
	 * @generated
	 */
