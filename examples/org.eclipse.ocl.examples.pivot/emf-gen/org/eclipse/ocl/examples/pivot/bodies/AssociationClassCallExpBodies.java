...
/**
 * AssociationClassCallExpBodies provides the Java implementation bodies of OCL-defined AssociationClassCallExp operations and properties.
 */
@SuppressWarnings("nls")
public class AssociationClassCallExpBodies
{

	/** 
	 * Implementation of the AssociationClassCallExp::allOCLExpressions '' <body>.
	 */
	...
	/** 
	 * Implementation of the AssociationClassCallExp::referredElements '' <body>.
	 */
	public static class _referredElements_body_ extends AbstractUnaryOperation
	{
		...
		/*
		Set{referredAssociationClass}
		*/
		public @NonNull Value evaluate(@NonNull DomainEvaluator evaluator, @NonNull DomainType returnType, final @NonNull Value self) throws InvalidValueException {
			final @NonNull ValueFactory valueFactory = evaluator.getValueFactory();
			final @NonNull DomainStandardLibrary standardLibrary = valueFactory.getStandardLibrary();
			final @NonNull ExecutorType T_pivot__AssociationClass = PivotTables.Types._AssociationClass;
			final @NonNull DomainCollectionType T_Set_pivot__AssociationClass_ = standardLibrary.getSetType(T_pivot__AssociationClass, null, null);
			final @NonNull ExecutorProperty P_AssociationClassCallExp_referredAssociationClass = PivotTables.Properties._AssociationClassCallExp__referredAssociationClass;
			final @NonNull LibraryProperty IP_AssociationClassCallExp_referredAssociationClass = P_AssociationClassCallExp_referredAssociationClass.getImplementation();
			
			
			Value A_symbol_4 = IP_AssociationClassCallExp_referredAssociationClass.evaluate(evaluator, T_pivot__AssociationClass, self, P_AssociationClassCallExp_referredAssociationClass);
			
			
			final @NonNull List<Value> lA_symbol_5 = new ArrayList<Value>(); 
			final @NonNull Value A_symbol_5 = valueFactory.createSetValue(T_Set_pivot__AssociationClass_, lA_symbol_5);
