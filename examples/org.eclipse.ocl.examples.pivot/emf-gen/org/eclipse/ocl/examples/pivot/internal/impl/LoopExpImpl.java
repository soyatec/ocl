...
public abstract class LoopExpImpl
	...
	public boolean validateSourceIsCollection(DiagnosticChain diagnostics, Map<Object, Object> context)
	{
		...
		*/
		...
		final @NonNull Object result = LoopExpBodies._invariant_SourceIsCollection.INSTANCE.evaluate(evaluator, T_Boolean, this);
	...
	public boolean validateNoInitializers(DiagnosticChain diagnostics, Map<Object, Object> context)
	{
		...
		*/
		...
		final @NonNull Object result = LoopExpBodies._invariant_NoInitializers.INSTANCE.evaluate(evaluator, T_Boolean, this);
		final boolean resultIsNull = ValuesUtil.isNull(result);
		if (!resultIsNull && ValuesUtil.asBoolean(result)) {	// true => true, false/null => dropthrough, invalid => exception
			return true;
		}
