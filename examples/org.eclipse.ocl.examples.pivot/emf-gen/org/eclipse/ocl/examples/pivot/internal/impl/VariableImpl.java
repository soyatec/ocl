 ...
 * <ul>
 *   <li>{@link org.eclipse.ocl.examples.pivot.internal.impl.VariableImpl#getTemplateParameter <em>Template Parameter</em>}</li>
 *   <li>{@link org.eclipse.ocl.examples.pivot.internal.impl.VariableImpl#getOwningTemplateParameter <em>Owning Template Parameter</em>}</li>
...
public class VariableImpl
		...
		if (templateParameter != null && ((EObject)templateParameter).eIsProxy())
		{
			...
			if (templateParameter != oldTemplateParameter)
			{
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, PivotPackage.VARIABLE__TEMPLATE_PARAMETER, oldTemplateParameter, templateParameter));
			}
		}
	...
	public NotificationChain basicSetTemplateParameter(TemplateParameter newTemplateParameter, NotificationChain msgs)
	{
		...
		if (eNotificationRequired())
		{
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, PivotPackage.VARIABLE__TEMPLATE_PARAMETER, oldTemplateParameter, newTemplateParameter);
	...
	public void setTemplateParameter(TemplateParameter newTemplateParameter)
	{
		if (newTemplateParameter != templateParameter)
		{
			...
			eNotify(new ENotificationImpl(this, Notification.SET, PivotPackage.VARIABLE__TEMPLATE_PARAMETER, newTemplateParameter, newTemplateParameter));
	}
	...
	{
		if (eContainerFeatureID() != PivotPackage.VARIABLE__OWNING_TEMPLATE_PARAMETER) return null;
	...
	{
		msgs = eBasicSetContainer((InternalEObject)newOwningTemplateParameter, PivotPackage.VARIABLE__OWNING_TEMPLATE_PARAMETER, msgs);
		Resource.Internal eInternalResource = eInternalResource();
		if (eInternalResource == null || !eInternalResource.isLoading()) {
	...
	{
		if (newOwningTemplateParameter != eInternalContainer() || (eContainerFeatureID() != PivotPackage.VARIABLE__OWNING_TEMPLATE_PARAMETER && newOwningTemplateParameter != null))
		{
			...
			eNotify(new ENotificationImpl(this, Notification.SET, PivotPackage.VARIABLE__OWNING_TEMPLATE_PARAMETER, newOwningTemplateParameter, newOwningTemplateParameter));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs)
	{
		switch (featureID)
		{
			...
			case PivotPackage.VARIABLE__OWNING_TEMPLATE_PARAMETER:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
				return basicSetOwningTemplateParameter((TemplateParameter)otherEnd, msgs);
			case PivotPackage.VARIABLE__TEMPLATE_PARAMETER:
				if (templateParameter != null)
					msgs = ((InternalEObject)templateParameter).eInverseRemove(this, PivotPackage.TEMPLATE_PARAMETER__PARAMETERED_ELEMENT, TemplateParameter.class, msgs);
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass)
	{
		if (baseClass == ParameterableElement.class)
		{
			...
			{
				case PivotPackage.VARIABLE__OWNING_TEMPLATE_PARAMETER: return PivotPackage.PARAMETERABLE_ELEMENT__OWNING_TEMPLATE_PARAMETER;
				case PivotPackage.VARIABLE__TEMPLATE_PARAMETER: return PivotPackage.PARAMETERABLE_ELEMENT__TEMPLATE_PARAMETER;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass)
	{
		if (baseClass == ParameterableElement.class)
		{
			...
			{
				case PivotPackage.PARAMETERABLE_ELEMENT__OWNING_TEMPLATE_PARAMETER: return PivotPackage.VARIABLE__OWNING_TEMPLATE_PARAMETER;
				case PivotPackage.PARAMETERABLE_ELEMENT__TEMPLATE_PARAMETER: return PivotPackage.VARIABLE__TEMPLATE_PARAMETER;
				default: return -1;
			}
		}
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass)
	{
		if (baseClass == ParameterableElement.class)
		{
			...
			{
				case PivotPackage.PARAMETERABLE_ELEMENT___IS_TEMPLATE_PARAMETER: return PivotPackage.VARIABLE___IS_TEMPLATE_PARAMETER;
				case PivotPackage.PARAMETERABLE_ELEMENT___IS_COMPATIBLE_WITH__PARAMETERABLEELEMENT: return PivotPackage.VARIABLE___IS_COMPATIBLE_WITH__PARAMETERABLEELEMENT;
				default: return -1;
			}
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException
	{
		switch (operationID)
		{
			...
			case PivotPackage.VARIABLE___IS_TEMPLATE_PARAMETER:
				return isTemplateParameter();
			case PivotPackage.VARIABLE___IS_COMPATIBLE_WITH__PARAMETERABLEELEMENT:
