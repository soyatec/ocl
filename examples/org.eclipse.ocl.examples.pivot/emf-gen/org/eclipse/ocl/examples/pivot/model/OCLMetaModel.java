...
public class OCLMetaModel extends XMIResourceImpl
{
	...
	protected static class Contents extends LibraryContents
	{
		...
		protected final @NonNull Property pr_Constraint_Property = createProperty("Property", _Property);
		...
		protected final @NonNull Property pr_Constraint_specification = createProperty(PivotPackage.Literals.CONSTRAINT__SPECIFICATION, _ValueSpecification);
		...
		protected final @NonNull Property pr_OpaqueExpression_valueExpression = createProperty(PivotPackage.Literals.OPAQUE_EXPRESSION__VALUE_EXPRESSION, _ExpressionInOCL);
		...
		protected final @NonNull Property pr_Operation_bodyExpression = createProperty(PivotPackage.Literals.OPERATION__BODY_EXPRESSION, _Constraint);
		...
		protected final @NonNull Property pr_Property_derivationExpression = createProperty(PivotPackage.Literals.PROPERTY__DERIVATION_EXPRESSION, _Constraint);
		...
		protected void installProperties() {
			...
			ownedProperties.add(property = pr_Constraint_Property);
			property.setImplicit(true);
			property.setIsRequired(false);
			property.setIsResolveProxies(true);
			property.setOpposite(pr_Property_derivationExpression);
			...
			property.setIsRequired(false);
			property.setIsResolveProxies(true);
			ownedProperties.add(property = pr_Property_derivationExpression);
			property.setIsComposite(true);
			property.setIsRequired(false);
			property.setIsResolveProxies(true);
			property.setOpposite(pr_Constraint_Property);
