...
public class OCLMetaModel extends XMIResourceImpl
{
	...
	protected static class Contents extends LibraryContents
	{
		...
		protected final @NonNull Property pr_Constraint_context = createProperty(PivotPackage.Literals.CONSTRAINT__CONTEXT, _NamedElement);
		...
		protected final @NonNull Property pr_Constraint_stereotype = createProperty(PivotPackage.Literals.CONSTRAINT__STEREOTYPE, _String);
		...
		protected final @NonNull Property pr_NamedElement_ownedRule = createProperty(PivotPackage.Literals.NAMED_ELEMENT__OWNED_RULE, _OrderedSet_Constraint);
