	...
	public static class _isCompatibleWith_body_ extends AbstractBinaryOperation
	{
		...
		*/
		public Value evaluate(DomainEvaluator evaluator, DomainType returnType, final Value self, final Value p) throws InvalidValueException {
			...
			DomainType static_A_symbol_323 = valueFactory.typeOf(self);
			LibraryUnaryOperation dynamic_A_symbol_323 = (LibraryUnaryOperation)static_A_symbol_323.lookupImplementation(standardLibrary, O_OclAny_oclType);
			Value A_symbol_323 = dynamic_A_symbol_323.evaluate(evaluator, T_AnyClassifier_pivot__ParameterableElement_, self);
			DomainType static_A_symbol_324 = valueFactory.typeOf(p);
			...
			Value A_symbol_324 = dynamic_A_symbol_324.evaluate(evaluator, T_Boolean, p, A_symbol_323);
			return A_symbol_324;
		}
	}
