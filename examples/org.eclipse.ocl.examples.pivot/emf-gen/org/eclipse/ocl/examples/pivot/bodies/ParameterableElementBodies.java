	...
	public static class _isCompatibleWith_body_ extends AbstractBinaryOperation
	{
		...
		*/
		public @NonNull Value evaluate(@NonNull DomainEvaluator evaluator, @NonNull DomainType returnType, final @NonNull Value self, final @NonNull Value p) throws InvalidValueException {
			...
			LibraryUnaryOperation dynamic_A_symbol_22 = (LibraryUnaryOperation)static_A_symbol_22.lookupImplementation(standardLibrary, O_OclAny_oclType);
			Value A_symbol_22 = dynamic_A_symbol_22.evaluate(evaluator, T_AnyClassifier_pivot__ParameterableElement_, self);
			DomainType static_A_symbol_23 = valueFactory.typeOf(p);
			...
			Value A_symbol_23 = dynamic_A_symbol_23.evaluate(evaluator, T_Boolean, p, A_symbol_22);
			return A_symbol_23;
		}
	}
