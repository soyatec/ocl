	...
	public static class _isCompatibleWith_body_ extends AbstractBinaryOperation
	{
		...
		*/
		public Value evaluate(DomainEvaluator evaluator, DomainType returnType, final Value self, final Value p) throws InvalidValueException {
			...
			DomainType static_A_symbol_2 = valueFactory.typeOf(self);
			LibraryUnaryOperation dynamic_A_symbol_2 = (LibraryUnaryOperation)static_A_symbol_2.lookupImplementation(standardLibrary, O_OclAny_oclType);
			Value A_symbol_2 = dynamic_A_symbol_2.evaluate(evaluator, T_AnyClassifier_Pivot_ecore__pivot__ParameterableElement_, self);
			DomainType static_A_symbol_3 = valueFactory.typeOf(p);
			LibraryBinaryOperation dynamic_A_symbol_3 = (LibraryBinaryOperation)static_A_symbol_3.lookupImplementation(standardLibrary, O_OclAny_oclIsKindOf);
			Value A_symbol_3 = dynamic_A_symbol_3.evaluate(evaluator, T_Boolean, p, A_symbol_2);
			return A_symbol_3;
		}
	}
