...
public class OperationCallExpImpl
	...
	public boolean validateArgumentCount(DiagnosticChain diagnostics, Map<Object, Object> context)
	{
		...
		*/
		try {
			...
			final @NonNull Object result = OperationCallExpBodies._invariant_ArgumentCount.INSTANCE.evaluate(evaluator, returnType.getTypeId(), this);
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass)
	{
		if (baseClass == ReferringElement.class)
		{
			...
			{
				case PivotPackage.REFERRING_ELEMENT___REFERRED_ELEMENT: return PivotPackage.OPERATION_CALL_EXP___REFERRED_ELEMENT;
				default: return -1;
			}
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException
	{
		switch (operationID)
		{
			...
			case PivotPackage.OPERATION_CALL_EXP___REFERRED_ELEMENT:
