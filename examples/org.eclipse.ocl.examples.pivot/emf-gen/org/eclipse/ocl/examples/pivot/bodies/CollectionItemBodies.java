	...
	public static class _invariant_TypeIsItemType extends AbstractUnaryOperation
	{
		...
		*/
		public @NonNull Object evaluate(@NonNull DomainEvaluator evaluator, @NonNull DomainType returnType, final @NonNull Object self) throws InvalidValueException {
			...
			Object A_symbol__1 = IP_CollectionItem_item.evaluate(evaluator, T_pivot__OCLExpression, self, P_CollectionItem_item);
			
			Object A_symbol__2 = IP_TypedElement_type.evaluate(evaluator, T_Type, A_symbol__1, P_TypedElement_type);
