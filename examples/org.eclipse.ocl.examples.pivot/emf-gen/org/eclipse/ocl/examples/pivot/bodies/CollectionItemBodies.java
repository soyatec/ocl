	...
	public static class _invariant_TypeIsItemType extends AbstractUnaryOperation
	{
		...
		*/
		public @NonNull Value evaluate(@NonNull DomainEvaluator evaluator, @NonNull DomainType returnType, final @NonNull Value self) throws InvalidValueException {
			...
			Value A_symbol_65 = IP_TypedElement_type.evaluate(evaluator, T_Type, self, P_TypedElement_type);
			
			
			Value A_symbol_66 = IP_CollectionItem_item.evaluate(evaluator, T_pivot__OCLExpression, self, P_CollectionItem_item);
			
			Value A_symbol_67 = IP_TypedElement_type.evaluate(evaluator, T_Type, A_symbol_66, P_TypedElement_type);
			
			DomainType static_A_symbol_68 = valueFactory.typeOf(A_symbol_65, A_symbol_67);
			LibraryBinaryOperation dynamic_A_symbol_68 = (LibraryBinaryOperation)static_A_symbol_68.lookupImplementation(standardLibrary, O_OclAny__eq_);
			Value A_symbol_68 = dynamic_A_symbol_68.evaluate(evaluator, T_Boolean, A_symbol_65, A_symbol_67);
			return A_symbol_68;
		}
	}
