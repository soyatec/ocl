...
public class IterateExpImpl extends LoopExpImpl implements IterateExp
{
	...
	public boolean validateTypeIsResultType(DiagnosticChain diagnostics, Map<Object, Object> context)
	{
		...
		*/
		try {
			...
			final @NonNull Object result = IterateExpBodies._invariant_TypeIsResultType.INSTANCE.evaluate(evaluator, returnType.getTypeId(), this);
	...
	public boolean validateBodyTypeConformsToResultType(DiagnosticChain diagnostics, Map<Object, Object> context)
	{
		...
		*/
		try {
			...
			final @NonNull DomainType returnType = T_Boolean;
			final @NonNull Object result = IterateExpBodies._invariant_BodyTypeConformsToResultType.INSTANCE.evaluate(evaluator, returnType.getTypeId(), this);
			final boolean resultIsNull = ValuesUtil.isNull(result);
			if (!resultIsNull && ValuesUtil.asBoolean(result)) {	// true => true, false/null => dropthrough, invalid => exception
				return true;
			}
	...
	public boolean validateOneInitializer(DiagnosticChain diagnostics, Map<Object, Object> context)
	{
		...
		*/
		try {
			...
			final @NonNull DomainType returnType = T_Boolean;
			final @NonNull Object result = IterateExpBodies._invariant_OneInitializer.INSTANCE.evaluate(evaluator, returnType.getTypeId(), this);
			final boolean resultIsNull = ValuesUtil.isNull(result);
			if (!resultIsNull && ValuesUtil.asBoolean(result)) {	// true => true, false/null => dropthrough, invalid => exception
				return true;
			}
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass)
	{
		if (baseClass == ReferringElement.class)
		{
			...
			{
				case PivotPackage.REFERRING_ELEMENT___REFERRED_ELEMENT: return PivotPackage.ITERATE_EXP___REFERRED_ELEMENT;
				default: return -1;
			}
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException
	{
		switch (operationID)
		{
			...
			case PivotPackage.ITERATE_EXP___REFERRED_ELEMENT:
