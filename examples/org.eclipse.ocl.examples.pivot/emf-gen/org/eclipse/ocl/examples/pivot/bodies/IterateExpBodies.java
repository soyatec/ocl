	...
	public static class _invariant_BodyTypeConformsToResultType extends AbstractUnaryOperation
	{
		...
		*/
		public Value evaluate(DomainEvaluator evaluator, DomainType returnType, final Value self) throws InvalidValueException {
			...
			Value A_symbol_356 = IP_LoopExp_body.evaluate(evaluator, T_pivot__OCLExpression, self, P_LoopExp_body);
			
			Value A_symbol_357 = IP_TypedElement_type.evaluate(evaluator, T_Type, A_symbol_356, P_TypedElement_type);
			
			
			Value A_symbol_358 = IP_IterateExp_result.evaluate(evaluator, T_pivot__Variable, self, P_IterateExp_result);
			
			Value A_symbol_359 = IP_TypedElement_type.evaluate(evaluator, T_Type, A_symbol_358, P_TypedElement_type);
			
			DomainType static_A_symbol_360 = valueFactory.typeOf(A_symbol_357);
			...
			Value A_symbol_360 = dynamic_A_symbol_360.evaluate(evaluator, T_Boolean, A_symbol_357, A_symbol_359);
			return A_symbol_360;
		}
	}
	...
	public static class _invariant_OneInitializer extends AbstractUnaryOperation
	{
		...
		*/
		public Value evaluate(DomainEvaluator evaluator, DomainType returnType, final Value self) throws InvalidValueException {
			...
			Value A_symbol_361 = IP_IterateExp_result.evaluate(evaluator, T_pivot__Variable, self, P_IterateExp_result);
			
			Value A_symbol_362 = IP_Variable_initExpression.evaluate(evaluator, T_pivot__OCLExpression, A_symbol_361, P_Variable_initExpression);
			
			DomainType static_A_symbol_363 = valueFactory.typeOf(A_symbol_362);
			LibraryUnaryOperation dynamic_A_symbol_363 = (LibraryUnaryOperation)static_A_symbol_363.lookupImplementation(standardLibrary, O_OclAny_oclAsSet);
			Value A_symbol_363 = dynamic_A_symbol_363.evaluate(evaluator, T_Set_pivot__OCLExpression_, A_symbol_362);
	...
	public static class _invariant_TypeIsResultType extends AbstractUnaryOperation
	{
		...
		*/
		public Value evaluate(DomainEvaluator evaluator, DomainType returnType, final Value self) throws InvalidValueException {
			...
			Value A_symbol_366 = IP_TypedElement_type.evaluate(evaluator, T_Type, self, P_TypedElement_type);
			
			
			Value A_symbol_367 = IP_IterateExp_result.evaluate(evaluator, T_pivot__Variable, self, P_IterateExp_result);
			
			Value A_symbol_368 = IP_TypedElement_type.evaluate(evaluator, T_Type, A_symbol_367, P_TypedElement_type);
			
			DomainType static_A_symbol_369 = valueFactory.typeOf(A_symbol_366, A_symbol_368);
			...
			Value A_symbol_369 = dynamic_A_symbol_369.evaluate(evaluator, T_Boolean, A_symbol_366, A_symbol_368);
			return A_symbol_369;
		}
	}
