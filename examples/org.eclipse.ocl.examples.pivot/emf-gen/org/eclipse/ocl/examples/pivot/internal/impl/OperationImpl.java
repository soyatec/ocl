...
//		throw new UnsupportedOperationException();	// FIXME Eliminate this feature once Acceleo bug 349278 fixed
	...
	public boolean validateCompatibleReturn(final DiagnosticChain diagnostics, final Map<Object, Object> context)
	{
		...
		try {
		    ...
		    try {
		        @Nullable /*@Caught*/ Object CAUGHT_bodyExpression;
		        try {
		            ...
		            CAUGHT_bodyExpression = self_71;
		        }
		        catch (Exception e) {
		            CAUGHT_bodyExpression = ValuesUtil.createInvalidValue(e);
		        }
		        final @NonNull /*@NonInvalid*/ DomainEvaluator evaluator = new EcoreExecutorManager(this, PivotTables.LIBRARY);
		        ...
		        final /*@NonInvalid*/ boolean symbol_0 = CAUGHT_bodyExpression instanceof InvalidValueException;
		        ...
		        if (symbol_0) {
		            ...
		            if (symbol_1) {
		                if (CAUGHT_bodyExpression instanceof InvalidValueException) {
		                    throw (InvalidValueException)CAUGHT_bodyExpression;
		                }
		                symbol_3 = (Boolean)CAUGHT_bodyExpression;
		            }
		            else {
		                ...
		                if (eq) {
		                    ...
		                    symbol_2 = (Boolean)CAUGHT_bodyExpression;
		                }
		                symbol_3 = symbol_2;
		            }
		            symbol_8 = symbol_3;
		            ...
		            final /*@Thrown*/ boolean eq_0 = CAUGHT_bodyExpression == Boolean.FALSE;
