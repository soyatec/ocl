	  ...
	  then
		...
		*/
		public @NonNull Value evaluate(@NonNull DomainEvaluator evaluator, @NonNull DomainType returnType, final @NonNull Value self, final @NonNull Value bodySpecification) throws InvalidValueException {
			...
			final @NonNull Value V_bodyType = A_symbol_0;
				...
				Value A_symbol_1 = dynamic_A_symbol_1.evaluate(evaluator, T_Boolean, V_bodyType, T_ClassClassifier_pivot__CollectionType_);
			Value A_symbol_2;
			if (A_symbol_1.isTrue()) {
				...
				Value A_symbol_3 = dynamic_A_symbol_3.evaluate(evaluator, T_pivot__CollectionType, V_bodyType, T_ClassClassifier_pivot__CollectionType_);
				final @NonNull Value V_bodyCollectionType = A_symbol_3;
				
				Value A_symbol_4 = IP_CollectionType_elementType.evaluate(evaluator, T_Type, V_bodyCollectionType, P_CollectionType_elementType);
				
				final @NonNull Value V_bodyElementType = A_symbol_4;
				...
				try {
					...
					try {
						...
						Value A_symbol_7 = IP_TypedElement_type.evaluate(evaluator, T_Type, self, P_TypedElement_type);
					...
					try {
						...
						try {
							...
							try {
								...
								Value A_symbol_12 = dynamic_A_symbol_12.evaluate(evaluator, T_Boolean, V_bodyCollectionType, T_CollectionClassifier_OrderedSet_OclAny__OclAny_);
							...
							try {
								...
								LibraryBinaryOperation dynamic_A_symbol_13 = (LibraryBinaryOperation)static_A_symbol_13.lookupImplementation(standardLibrary, O_OclType_conformsTo);
								Value A_symbol_13 = dynamic_A_symbol_13.evaluate(evaluator, T_Boolean, V_bodyCollectionType, T_CollectionClassifier_Sequence_OclAny__OclAny_);
					...
					leftA_symbol_5 = valueFactory.createInvalidValue(e);
				}
				...
				try {
					...
					try {
						...
						try {
							...
							Value A_symbol_17 = dynamic_A_symbol_17.evaluate(evaluator, T_Boolean, V_bodyCollectionType, T_CollectionClassifier_OrderedSet_OclAny__OclAny_);
						...
						try {
							...
							Value A_symbol_18 = dynamic_A_symbol_18.evaluate(evaluator, T_Boolean, V_bodyCollectionType, T_CollectionClassifier_Set_OclAny__OclAny_);
					...
					rightA_symbol_5 = valueFactory.createInvalidValue(e);
				}
				...
				final @NonNull Value A_symbol_19 = A_symbol_5;
				final @NonNull Value A_symbol_20 = A_symbol_19;
				A_symbol_2 = A_symbol_20;
			}
			else if (A_symbol_1.isFalse()) {
				
				
				Value A_symbol_21 = IP_TypedElement_type.evaluate(evaluator, T_Type, self, P_TypedElement_type);
