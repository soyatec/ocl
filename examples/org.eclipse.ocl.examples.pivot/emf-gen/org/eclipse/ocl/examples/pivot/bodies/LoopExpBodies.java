	...
	public static class _invariant_NoInitializers extends AbstractUnaryOperation
	{
		...
		*/
		public Value evaluate(DomainEvaluator evaluator, DomainType returnType, final Value self) throws InvalidValueException {
			...
			Value A_symbol_40 = IP_LoopExp_iterator.evaluate(evaluator, T_OrderedSet_Pivot_ecore__pivot__Variable_, self, P_LoopExp_iterator);
			
			
			/** 
			 * Implementation of the iterator body.
			 */
			AbstractBinaryOperation body_A_symbol_41 = new AbstractBinaryOperation()
			{
			/*
			...
			*/
				public Value evaluate(DomainEvaluator evaluator, DomainType returnType, Value sourceValue, Value iterator1) throws InvalidValueException {
					...
					Value A_symbol_42 = IP_Variable_initExpression.evaluate(evaluator, T_Pivot_ecore__pivot__OCLExpression, V_1_, P_Variable_initExpression);
					...
					Value A_symbol_43 = dynamic_A_symbol_43.evaluate(evaluator, T_Set_Pivot_ecore__pivot__OCLExpression_, A_symbol_42);
					DomainType static_A_symbol_44 = valueFactory.typeOf(A_symbol_43);
					LibraryUnaryOperation dynamic_A_symbol_44 = (LibraryUnaryOperation)static_A_symbol_44.lookupImplementation(standardLibrary, O_Collection_isEmpty);
					Value A_symbol_44 = dynamic_A_symbol_44.evaluate(evaluator, T_Boolean, A_symbol_43);
					return A_symbol_44;
				}
			};
			DomainType static_A_symbol_41 = A_symbol_40.getType();
			LibraryIteration dynamic_A_symbol_41 = (LibraryIteration)static_A_symbol_41.lookupImplementation(standardLibrary, O_Collection_forAll);
			Value acc_A_symbol_41 = dynamic_A_symbol_41.createAccumulatorValue(evaluator, T_Boolean, T_Boolean);
			ExecutorSingleIterationManager manager_A_symbol_41 = new ExecutorSingleIterationManager(evaluator, T_Boolean, body_A_symbol_41, (CollectionValue)A_symbol_40, acc_A_symbol_41);
			Value A_symbol_41 = dynamic_A_symbol_41.evaluateIteration(manager_A_symbol_41);
			return A_symbol_41;
		}
	}
	...
	public static class _invariant_SourceIsCollection extends AbstractUnaryOperation
	{
		...
		*/
		public Value evaluate(DomainEvaluator evaluator, DomainType returnType, final Value self) throws InvalidValueException {
			...
			Value A_symbol_47 = dynamic_A_symbol_47.evaluate(evaluator, T_Boolean, A_symbol_46, T_ClassClassifier_Pivot_ecore__pivot__CollectionType_);
			return A_symbol_47;
		}
	}
