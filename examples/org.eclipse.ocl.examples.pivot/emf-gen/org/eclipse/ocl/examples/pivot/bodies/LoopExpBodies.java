	...
	public static class _invariant_NoInitializers extends AbstractUnaryOperation
	{
		...
		*/
		public Value evaluate(DomainEvaluator evaluator, DomainType returnType, final Value self) throws InvalidValueException {
			...
			Value A_symbol_303 = IP_LoopExp_iterator.evaluate(evaluator, T_OrderedSet_Pivot_ecore__pivot__Variable_, self, P_LoopExp_iterator);
			
			
			/** 
			 * Implementation of the iterator body.
			 */
			AbstractBinaryOperation body_A_symbol_304 = new AbstractBinaryOperation()
			{
			/*
			...
			*/
				public Value evaluate(DomainEvaluator evaluator, DomainType returnType, Value sourceValue, Value iterator1) throws InvalidValueException {
					...
					Value A_symbol_305 = IP_Variable_initExpression.evaluate(evaluator, T_Pivot_ecore__pivot__OCLExpression, V_1_, P_Variable_initExpression);
					
					DomainType static_A_symbol_306 = valueFactory.typeOf(A_symbol_305);
					LibraryUnaryOperation dynamic_A_symbol_306 = (LibraryUnaryOperation)static_A_symbol_306.lookupImplementation(standardLibrary, O_OclAny_oclAsSet);
					Value A_symbol_306 = dynamic_A_symbol_306.evaluate(evaluator, T_Set_Pivot_ecore__pivot__OCLExpression_, A_symbol_305);
					DomainType static_A_symbol_307 = valueFactory.typeOf(A_symbol_306);
					LibraryUnaryOperation dynamic_A_symbol_307 = (LibraryUnaryOperation)static_A_symbol_307.lookupImplementation(standardLibrary, O_Collection_isEmpty);
					Value A_symbol_307 = dynamic_A_symbol_307.evaluate(evaluator, T_Boolean, A_symbol_306);
					return A_symbol_307;
				}
			};
			DomainType static_A_symbol_304 = A_symbol_303.getType();
			LibraryIteration dynamic_A_symbol_304 = (LibraryIteration)static_A_symbol_304.lookupImplementation(standardLibrary, O_Collection_forAll);
			Value acc_A_symbol_304 = dynamic_A_symbol_304.createAccumulatorValue(evaluator, T_Boolean, T_Boolean);
			ExecutorSingleIterationManager manager_A_symbol_304 = new ExecutorSingleIterationManager(evaluator, T_Boolean, body_A_symbol_304, (CollectionValue)A_symbol_303, acc_A_symbol_304);
			Value A_symbol_304 = dynamic_A_symbol_304.evaluateIteration(manager_A_symbol_304);
			return A_symbol_304;
		}
	}
	...
	public static class _invariant_SourceIsCollection extends AbstractUnaryOperation
	{
		...
		*/
		public Value evaluate(DomainEvaluator evaluator, DomainType returnType, final Value self) throws InvalidValueException {
			...
			Value A_symbol_308 = IP_CallExp_source.evaluate(evaluator, T_Pivot_ecore__pivot__OCLExpression, self, P_CallExp_source);
			...
			Value A_symbol_310 = dynamic_A_symbol_310.evaluate(evaluator, T_Boolean, A_symbol_309, T_ClassClassifier_Pivot_ecore__pivot__CollectionType_);
			return A_symbol_310;
		}
	}
