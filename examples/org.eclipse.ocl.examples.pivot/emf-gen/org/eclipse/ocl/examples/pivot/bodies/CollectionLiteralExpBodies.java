	...
	public static class _invariant_BagKindIsBag extends AbstractUnaryOperation
	{
		...
		*/
		public @NonNull Value evaluate(@NonNull DomainEvaluator evaluator, @NonNull DomainType returnType, final @NonNull Value self) throws InvalidValueException {
			...
			final @NonNull Value A_symbol_ = valueFactory.createEnumerationLiteralValue(PivotTables.EnumerationLiterals._CollectionKind__Bag);
			...
			Value leftA_symbol__1;
			try {
				
				Value A_symbol__2 = IP_CollectionLiteralExp_kind.evaluate(evaluator, T_pivot__CollectionKind, self, P_CollectionLiteralExp_kind);
				...
				Value A_symbol__3 = dynamic_A_symbol__3.evaluate(evaluator, T_Boolean, A_symbol__2, A_symbol_);
				leftA_symbol__1 = A_symbol__3;
			} catch (InvalidValueException e) {
				leftA_symbol__1 = valueFactory.createInvalidValue(e);
			}
			Value A_symbol__3 = leftA_symbol__1;
			Value rightA_symbol__1;
			try {
				
				Value A_symbol__4 = IP_TypedElement_type.evaluate(evaluator, T_Type, self, P_TypedElement_type);
				...
				Value A_symbol__5 = dynamic_A_symbol__5.evaluate(evaluator, T_Boolean, A_symbol__4, T_Metaclass_pivot__BagType_);
				rightA_symbol__1 = A_symbol__5;
			} catch (InvalidValueException e) {
				rightA_symbol__1 = valueFactory.createInvalidValue(e);
			}
			Value A_symbol__5 = rightA_symbol__1;
			...
			Value A_symbol__1 = dynamic_A_symbol__1.evaluate(evaluator, T_Boolean, A_symbol__3, A_symbol__5);
			return A_symbol__1;
		}
	}
	...
	public static class _invariant_CollectionKindIsConcrete extends AbstractUnaryOperation
	{
		...
		*/
		public @NonNull Value evaluate(@NonNull DomainEvaluator evaluator, @NonNull DomainType returnType, final @NonNull Value self) throws InvalidValueException {
			...
			final @NonNull ExecutorProperty P_CollectionLiteralExp_kind = PivotTables.Properties._CollectionLiteralExp__kind;
			final @NonNull LibraryProperty IP_CollectionLiteralExp_kind = P_CollectionLiteralExp_kind.getImplementation();
			final @NonNull Value A_symbol__6 = valueFactory.createEnumerationLiteralValue(PivotTables.EnumerationLiterals._CollectionKind__Collection);
			
			
			Value A_symbol__7 = IP_CollectionLiteralExp_kind.evaluate(evaluator, T_pivot__CollectionKind, self, P_CollectionLiteralExp_kind);
			...
			Value A_symbol__8 = dynamic_A_symbol__8.evaluate(evaluator, T_Boolean, A_symbol__7, A_symbol__6);
			return A_symbol__8;
		}
	}
	...
	type.oclIsKindOf(OrderedSetType)
		*/
		public @NonNull Value evaluate(@NonNull DomainEvaluator evaluator, @NonNull DomainType returnType, final @NonNull Value self) throws InvalidValueException {
			...
			final @NonNull ExecutorProperty P_CollectionLiteralExp_kind = PivotTables.Properties._CollectionLiteralExp__kind;
			final @NonNull LibraryProperty IP_CollectionLiteralExp_kind = P_CollectionLiteralExp_kind.getImplementation();
			final @NonNull Value A_symbol__9 = valueFactory.createEnumerationLiteralValue(PivotTables.EnumerationLiterals._CollectionKind__OrderedSet);
			final @NonNull ExecutorOperation O_OclAny_oclIsKindOf = OCLstdlibTables.Operations._OclAny__oclIsKindOf;
			final @NonNull ExecutorType T_Type = OCLstdlibTables.Types._Type;
			final @NonNull ExecutorProperty P_TypedElement_type = PivotTables.Properties._TypedElement__type;
			final @NonNull LibraryProperty IP_TypedElement_type = P_TypedElement_type.getImplementation();
			...
			Value leftA_symbol__10;
			try {
				
				Value A_symbol__11 = IP_CollectionLiteralExp_kind.evaluate(evaluator, T_pivot__CollectionKind, self, P_CollectionLiteralExp_kind);
				...
				Value A_symbol__12 = dynamic_A_symbol__12.evaluate(evaluator, T_Boolean, A_symbol__11, A_symbol__9);
				leftA_symbol__10 = A_symbol__12;
			} catch (InvalidValueException e) {
				leftA_symbol__10 = valueFactory.createInvalidValue(e);
			}
			Value A_symbol__12 = leftA_symbol__10;
			Value rightA_symbol__10;
			try {
				
				Value A_symbol__13 = IP_TypedElement_type.evaluate(evaluator, T_Type, self, P_TypedElement_type);
				...
				Value A_symbol__14 = dynamic_A_symbol__14.evaluate(evaluator, T_Boolean, A_symbol__13, T_Metaclass_pivot__OrderedSetType_);
				rightA_symbol__10 = A_symbol__14;
			} catch (InvalidValueException e) {
				rightA_symbol__10 = valueFactory.createInvalidValue(e);
			}
			Value A_symbol__14 = rightA_symbol__10;
			...
			Value A_symbol__10 = dynamic_A_symbol__10.evaluate(evaluator, T_Boolean, A_symbol__12, A_symbol__14);
			return A_symbol__10;
		}
	}
	...
	type.oclIsKindOf(SequenceType)
		*/
		public @NonNull Value evaluate(@NonNull DomainEvaluator evaluator, @NonNull DomainType returnType, final @NonNull Value self) throws InvalidValueException {
			...
			final @NonNull ExecutorProperty P_CollectionLiteralExp_kind = PivotTables.Properties._CollectionLiteralExp__kind;
			final @NonNull LibraryProperty IP_CollectionLiteralExp_kind = P_CollectionLiteralExp_kind.getImplementation();
			final @NonNull Value A_symbol__15 = valueFactory.createEnumerationLiteralValue(PivotTables.EnumerationLiterals._CollectionKind__Sequence);
			final @NonNull ExecutorOperation O_OclAny_oclIsKindOf = OCLstdlibTables.Operations._OclAny__oclIsKindOf;
			final @NonNull ExecutorType T_Type = OCLstdlibTables.Types._Type;
			final @NonNull ExecutorProperty P_TypedElement_type = PivotTables.Properties._TypedElement__type;
			final @NonNull LibraryProperty IP_TypedElement_type = P_TypedElement_type.getImplementation();
			...
			Value leftA_symbol__16;
			try {
				
				Value A_symbol__17 = IP_CollectionLiteralExp_kind.evaluate(evaluator, T_pivot__CollectionKind, self, P_CollectionLiteralExp_kind);
				...
				Value A_symbol__18 = dynamic_A_symbol__18.evaluate(evaluator, T_Boolean, A_symbol__17, A_symbol__15);
				leftA_symbol__16 = A_symbol__18;
			} catch (InvalidValueException e) {
				leftA_symbol__16 = valueFactory.createInvalidValue(e);
			}
			Value A_symbol__18 = leftA_symbol__16;
			Value rightA_symbol__16;
			try {
				
				Value A_symbol__19 = IP_TypedElement_type.evaluate(evaluator, T_Type, self, P_TypedElement_type);
				...
				Value A_symbol__20 = dynamic_A_symbol__20.evaluate(evaluator, T_Boolean, A_symbol__19, T_Metaclass_pivot__SequenceType_);
				rightA_symbol__16 = A_symbol__20;
			} catch (InvalidValueException e) {
				rightA_symbol__16 = valueFactory.createInvalidValue(e);
			}
			Value A_symbol__20 = rightA_symbol__16;
			...
			Value A_symbol__16 = dynamic_A_symbol__16.evaluate(evaluator, T_Boolean, A_symbol__18, A_symbol__20);
			return A_symbol__16;
		}
	}
	...
	public static class _invariant_SetKindIsSet extends AbstractUnaryOperation
	{
		...
		*/
		public @NonNull Value evaluate(@NonNull DomainEvaluator evaluator, @NonNull DomainType returnType, final @NonNull Value self) throws InvalidValueException {
			...
			final @NonNull ExecutorProperty P_CollectionLiteralExp_kind = PivotTables.Properties._CollectionLiteralExp__kind;
			final @NonNull LibraryProperty IP_CollectionLiteralExp_kind = P_CollectionLiteralExp_kind.getImplementation();
			final @NonNull Value A_symbol__21 = valueFactory.createEnumerationLiteralValue(PivotTables.EnumerationLiterals._CollectionKind__Set);
			final @NonNull ExecutorOperation O_OclAny_oclIsKindOf = OCLstdlibTables.Operations._OclAny__oclIsKindOf;
			final @NonNull ExecutorType T_Type = OCLstdlibTables.Types._Type;
			final @NonNull ExecutorProperty P_TypedElement_type = PivotTables.Properties._TypedElement__type;
			final @NonNull LibraryProperty IP_TypedElement_type = P_TypedElement_type.getImplementation();
			...
			Value leftA_symbol__22;
			try {
				
				Value A_symbol__23 = IP_CollectionLiteralExp_kind.evaluate(evaluator, T_pivot__CollectionKind, self, P_CollectionLiteralExp_kind);
				...
				Value A_symbol__24 = dynamic_A_symbol__24.evaluate(evaluator, T_Boolean, A_symbol__23, A_symbol__21);
				leftA_symbol__22 = A_symbol__24;
			} catch (InvalidValueException e) {
				leftA_symbol__22 = valueFactory.createInvalidValue(e);
			}
			Value A_symbol__24 = leftA_symbol__22;
			Value rightA_symbol__22;
			try {
				
				Value A_symbol__25 = IP_TypedElement_type.evaluate(evaluator, T_Type, self, P_TypedElement_type);
				...
				Value A_symbol__26 = dynamic_A_symbol__26.evaluate(evaluator, T_Boolean, A_symbol__25, T_Metaclass_pivot__SetType_);
				rightA_symbol__22 = A_symbol__26;
			} catch (InvalidValueException e) {
				rightA_symbol__22 = valueFactory.createInvalidValue(e);
			}
			Value A_symbol__26 = rightA_symbol__22;
			...
			Value A_symbol__22 = dynamic_A_symbol__22.evaluate(evaluator, T_Boolean, A_symbol__24, A_symbol__26);
			return A_symbol__22;
		}
	}
