	...
	public static class _invariant_BagKindIsBag extends AbstractUnaryOperation
	{
		...
		*/
		public @NonNull Object evaluate(@NonNull DomainEvaluator evaluator, @NonNull TypeId returnTypeId, final @NonNull Object self) throws InvalidValueException {
			...
			final @NonNull Object A_symbol_ = createEnumerationLiteralValue(PivotTables.EnumerationLiterals._CollectionKind__Bag);
			...
			try {
				...
				Object A_symbol__2 = IP_CollectionLiteralExp_kind.evaluate(evaluator, T_pivot__CollectionKind.getTypeId(), self, P_CollectionLiteralExp_kind);
			...
			try {
				...
				Object A_symbol__4 = IP_TypedElement_type.evaluate(evaluator, T_Type.getTypeId(), self, P_TypedElement_type);
	...
	public static class _invariant_CollectionKindIsConcrete extends AbstractUnaryOperation
	{
		...
		*/
		public @NonNull Object evaluate(@NonNull DomainEvaluator evaluator, @NonNull TypeId returnTypeId, final @NonNull Object self) throws InvalidValueException {
			...
			final @NonNull ExecutorProperty P_CollectionLiteralExp_kind = PivotTables.Properties._CollectionLiteralExp__kind;
			final @NonNull LibraryProperty IP_CollectionLiteralExp_kind = P_CollectionLiteralExp_kind.getImplementation();
			final @NonNull Object A_symbol__6 = createEnumerationLiteralValue(PivotTables.EnumerationLiterals._CollectionKind__Collection);
			
			
			Object A_symbol__7 = IP_CollectionLiteralExp_kind.evaluate(evaluator, T_pivot__CollectionKind.getTypeId(), self, P_CollectionLiteralExp_kind);
	...
	type.oclIsKindOf(OrderedSetType)
		*/
		public @NonNull Object evaluate(@NonNull DomainEvaluator evaluator, @NonNull TypeId returnTypeId, final @NonNull Object self) throws InvalidValueException {
			...
			final @NonNull ExecutorProperty P_CollectionLiteralExp_kind = PivotTables.Properties._CollectionLiteralExp__kind;
			final @NonNull LibraryProperty IP_CollectionLiteralExp_kind = P_CollectionLiteralExp_kind.getImplementation();
			final @NonNull Object A_symbol__9 = createEnumerationLiteralValue(PivotTables.EnumerationLiterals._CollectionKind__OrderedSet);
			final @NonNull ExecutorOperation O_OclAny_oclIsKindOf = OCLstdlibTables.Operations._OclAny__oclIsKindOf;
			final @NonNull ExecutorType T_Type = OCLstdlibTables.Types._Type;
			final @NonNull ExecutorProperty P_TypedElement_type = PivotTables.Properties._TypedElement__type;
			final @NonNull LibraryProperty IP_TypedElement_type = P_TypedElement_type.getImplementation();
			...
			try {
				...
				Object A_symbol__11 = IP_CollectionLiteralExp_kind.evaluate(evaluator, T_pivot__CollectionKind.getTypeId(), self, P_CollectionLiteralExp_kind);
			...
			try {
				...
				Object A_symbol__13 = IP_TypedElement_type.evaluate(evaluator, T_Type.getTypeId(), self, P_TypedElement_type);
	...
	type.oclIsKindOf(SequenceType)
		*/
		public @NonNull Object evaluate(@NonNull DomainEvaluator evaluator, @NonNull TypeId returnTypeId, final @NonNull Object self) throws InvalidValueException {
			...
			final @NonNull ExecutorProperty P_CollectionLiteralExp_kind = PivotTables.Properties._CollectionLiteralExp__kind;
			final @NonNull LibraryProperty IP_CollectionLiteralExp_kind = P_CollectionLiteralExp_kind.getImplementation();
			final @NonNull Object A_symbol__15 = createEnumerationLiteralValue(PivotTables.EnumerationLiterals._CollectionKind__Sequence);
			final @NonNull ExecutorOperation O_OclAny_oclIsKindOf = OCLstdlibTables.Operations._OclAny__oclIsKindOf;
			final @NonNull ExecutorType T_Type = OCLstdlibTables.Types._Type;
			final @NonNull ExecutorProperty P_TypedElement_type = PivotTables.Properties._TypedElement__type;
			final @NonNull LibraryProperty IP_TypedElement_type = P_TypedElement_type.getImplementation();
			...
			try {
				...
				Object A_symbol__17 = IP_CollectionLiteralExp_kind.evaluate(evaluator, T_pivot__CollectionKind.getTypeId(), self, P_CollectionLiteralExp_kind);
			...
			try {
				...
				Object A_symbol__19 = IP_TypedElement_type.evaluate(evaluator, T_Type.getTypeId(), self, P_TypedElement_type);
	...
	public static class _invariant_SetKindIsSet extends AbstractUnaryOperation
	{
		...
		*/
		public @NonNull Object evaluate(@NonNull DomainEvaluator evaluator, @NonNull TypeId returnTypeId, final @NonNull Object self) throws InvalidValueException {
			...
			final @NonNull ExecutorProperty P_CollectionLiteralExp_kind = PivotTables.Properties._CollectionLiteralExp__kind;
			final @NonNull LibraryProperty IP_CollectionLiteralExp_kind = P_CollectionLiteralExp_kind.getImplementation();
			final @NonNull Object A_symbol__21 = createEnumerationLiteralValue(PivotTables.EnumerationLiterals._CollectionKind__Set);
			final @NonNull ExecutorOperation O_OclAny_oclIsKindOf = OCLstdlibTables.Operations._OclAny__oclIsKindOf;
			final @NonNull ExecutorType T_Type = OCLstdlibTables.Types._Type;
			final @NonNull ExecutorProperty P_TypedElement_type = PivotTables.Properties._TypedElement__type;
			final @NonNull LibraryProperty IP_TypedElement_type = P_TypedElement_type.getImplementation();
			...
			try {
				...
				Object A_symbol__23 = IP_CollectionLiteralExp_kind.evaluate(evaluator, T_pivot__CollectionKind.getTypeId(), self, P_CollectionLiteralExp_kind);
			...
			try {
				...
				Object A_symbol__25 = IP_TypedElement_type.evaluate(evaluator, T_Type.getTypeId(), self, P_TypedElement_type);
