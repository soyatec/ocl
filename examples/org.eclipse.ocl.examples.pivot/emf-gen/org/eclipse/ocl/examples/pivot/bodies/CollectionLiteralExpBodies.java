	...
	public static class _invariant_BagKindIsBag extends AbstractUnaryOperation
	{
		...
		*/
		public @NonNull Value evaluate(@NonNull DomainEvaluator evaluator, @NonNull DomainType returnType, final @NonNull Value self) throws InvalidValueException {
			...
			final @NonNull Value A_symbol_384 = valueFactory.createEnumerationLiteralValue(PivotTables.EnumerationLiterals._CollectionKind__Bag);
			...
			try {
				...
				Value A_symbol_386 = IP_CollectionLiteralExp_kind.evaluate(evaluator, T_pivot__CollectionKind, self, P_CollectionLiteralExp_kind);
				
				
				DomainType static_A_symbol_387 = valueFactory.typeOf(A_symbol_386, A_symbol_384);
				...
				Value A_symbol_387 = dynamic_A_symbol_387.evaluate(evaluator, T_Boolean, A_symbol_386, A_symbol_384);
				leftA_symbol_385 = A_symbol_387;
			} catch (InvalidValueException e) {
				leftA_symbol_385 = valueFactory.createInvalidValue(e);
			}
			Value A_symbol_387 = leftA_symbol_385;
			Value rightA_symbol_385;
			try {
				
				Value A_symbol_388 = IP_TypedElement_type.evaluate(evaluator, T_Type, self, P_TypedElement_type);
				...
				Value A_symbol_389 = dynamic_A_symbol_389.evaluate(evaluator, T_Boolean, A_symbol_388, T_ClassClassifier_pivot__BagType_);
				rightA_symbol_385 = A_symbol_389;
			} catch (InvalidValueException e) {
				rightA_symbol_385 = valueFactory.createInvalidValue(e);
			}
			Value A_symbol_389 = rightA_symbol_385;
			DomainType static_A_symbol_385 = valueFactory.typeOf(A_symbol_387);
			LibraryBinaryOperation dynamic_A_symbol_385 = (LibraryBinaryOperation)static_A_symbol_385.lookupImplementation(standardLibrary, O_Boolean_implies);
			Value A_symbol_385 = dynamic_A_symbol_385.evaluate(evaluator, T_Boolean, A_symbol_387, A_symbol_389);
			return A_symbol_385;
		}
	}
	...
	public static class _invariant_CollectionKindIsConcrete extends AbstractUnaryOperation
	{
		...
		*/
		public @NonNull Value evaluate(@NonNull DomainEvaluator evaluator, @NonNull DomainType returnType, final @NonNull Value self) throws InvalidValueException {
			...
			final @NonNull ExecutorProperty P_CollectionLiteralExp_kind = PivotTables.Properties._CollectionLiteralExp__kind;
			final @NonNull LibraryProperty IP_CollectionLiteralExp_kind = P_CollectionLiteralExp_kind.getImplementation();
			final @NonNull Value A_symbol_390 = valueFactory.createEnumerationLiteralValue(PivotTables.EnumerationLiterals._CollectionKind__Collection);
			
			
			Value A_symbol_391 = IP_CollectionLiteralExp_kind.evaluate(evaluator, T_pivot__CollectionKind, self, P_CollectionLiteralExp_kind);
			
			
			DomainType static_A_symbol_392 = valueFactory.typeOf(A_symbol_391, A_symbol_390);
			...
			Value A_symbol_392 = dynamic_A_symbol_392.evaluate(evaluator, T_Boolean, A_symbol_391, A_symbol_390);
			return A_symbol_392;
		}
	}
	...
	type.oclIsKindOf(OrderedSetType)
		*/
		public @NonNull Value evaluate(@NonNull DomainEvaluator evaluator, @NonNull DomainType returnType, final @NonNull Value self) throws InvalidValueException {
			...
			final @NonNull ExecutorProperty P_CollectionLiteralExp_kind = PivotTables.Properties._CollectionLiteralExp__kind;
			final @NonNull LibraryProperty IP_CollectionLiteralExp_kind = P_CollectionLiteralExp_kind.getImplementation();
			final @NonNull Value A_symbol_393 = valueFactory.createEnumerationLiteralValue(PivotTables.EnumerationLiterals._CollectionKind__OrderedSet);
			final @NonNull ExecutorOperation O_OclAny_oclIsKindOf = OCLstdlibTables.Operations._OclAny__oclIsKindOf;
			final @NonNull ExecutorType T_Type = OCLstdlibTables.Types._Type;
			final @NonNull ExecutorProperty P_TypedElement_type = PivotTables.Properties._TypedElement__type;
			final @NonNull LibraryProperty IP_TypedElement_type = P_TypedElement_type.getImplementation();
			...
			try {
				...
				Value A_symbol_395 = IP_CollectionLiteralExp_kind.evaluate(evaluator, T_pivot__CollectionKind, self, P_CollectionLiteralExp_kind);
				
				
				DomainType static_A_symbol_396 = valueFactory.typeOf(A_symbol_395, A_symbol_393);
				LibraryBinaryOperation dynamic_A_symbol_396 = (LibraryBinaryOperation)static_A_symbol_396.lookupImplementation(standardLibrary, O_OclAny__eq_);
				Value A_symbol_396 = dynamic_A_symbol_396.evaluate(evaluator, T_Boolean, A_symbol_395, A_symbol_393);
			...
			try {
				...
				Value A_symbol_397 = IP_TypedElement_type.evaluate(evaluator, T_Type, self, P_TypedElement_type);
				
				DomainType static_A_symbol_398 = valueFactory.typeOf(A_symbol_397);
				LibraryBinaryOperation dynamic_A_symbol_398 = (LibraryBinaryOperation)static_A_symbol_398.lookupImplementation(standardLibrary, O_OclAny_oclIsKindOf);
				Value A_symbol_398 = dynamic_A_symbol_398.evaluate(evaluator, T_Boolean, A_symbol_397, T_ClassClassifier_pivot__OrderedSetType_);
			...
			Value A_symbol_394 = dynamic_A_symbol_394.evaluate(evaluator, T_Boolean, A_symbol_396, A_symbol_398);
			return A_symbol_394;
		}
	}
	...
	type.oclIsKindOf(SequenceType)
		*/
		public @NonNull Value evaluate(@NonNull DomainEvaluator evaluator, @NonNull DomainType returnType, final @NonNull Value self) throws InvalidValueException {
			...
			final @NonNull ExecutorProperty P_CollectionLiteralExp_kind = PivotTables.Properties._CollectionLiteralExp__kind;
			final @NonNull LibraryProperty IP_CollectionLiteralExp_kind = P_CollectionLiteralExp_kind.getImplementation();
			final @NonNull Value A_symbol_399 = valueFactory.createEnumerationLiteralValue(PivotTables.EnumerationLiterals._CollectionKind__Sequence);
			final @NonNull ExecutorOperation O_OclAny_oclIsKindOf = OCLstdlibTables.Operations._OclAny__oclIsKindOf;
			final @NonNull ExecutorType T_Type = OCLstdlibTables.Types._Type;
			final @NonNull ExecutorProperty P_TypedElement_type = PivotTables.Properties._TypedElement__type;
			final @NonNull LibraryProperty IP_TypedElement_type = P_TypedElement_type.getImplementation();
			...
			try {
				...
				Value A_symbol_401 = IP_CollectionLiteralExp_kind.evaluate(evaluator, T_pivot__CollectionKind, self, P_CollectionLiteralExp_kind);
				
				
				DomainType static_A_symbol_402 = valueFactory.typeOf(A_symbol_401, A_symbol_399);
				...
				Value A_symbol_402 = dynamic_A_symbol_402.evaluate(evaluator, T_Boolean, A_symbol_401, A_symbol_399);
			...
			try {
				...
				Value A_symbol_403 = IP_TypedElement_type.evaluate(evaluator, T_Type, self, P_TypedElement_type);
				
				DomainType static_A_symbol_404 = valueFactory.typeOf(A_symbol_403);
				LibraryBinaryOperation dynamic_A_symbol_404 = (LibraryBinaryOperation)static_A_symbol_404.lookupImplementation(standardLibrary, O_OclAny_oclIsKindOf);
				Value A_symbol_404 = dynamic_A_symbol_404.evaluate(evaluator, T_Boolean, A_symbol_403, T_ClassClassifier_pivot__SequenceType_);
				rightA_symbol_400 = A_symbol_404;
			} catch (InvalidValueException e) {
				rightA_symbol_400 = valueFactory.createInvalidValue(e);
			}
			Value A_symbol_404 = rightA_symbol_400;
			...
			Value A_symbol_400 = dynamic_A_symbol_400.evaluate(evaluator, T_Boolean, A_symbol_402, A_symbol_404);
			return A_symbol_400;
		}
	}
	...
	public static class _invariant_SetKindIsSet extends AbstractUnaryOperation
	{
		...
		*/
		public @NonNull Value evaluate(@NonNull DomainEvaluator evaluator, @NonNull DomainType returnType, final @NonNull Value self) throws InvalidValueException {
			...
			final @NonNull ExecutorProperty P_CollectionLiteralExp_kind = PivotTables.Properties._CollectionLiteralExp__kind;
			final @NonNull LibraryProperty IP_CollectionLiteralExp_kind = P_CollectionLiteralExp_kind.getImplementation();
			final @NonNull Value A_symbol_405 = valueFactory.createEnumerationLiteralValue(PivotTables.EnumerationLiterals._CollectionKind__Set);
			final @NonNull ExecutorOperation O_OclAny_oclIsKindOf = OCLstdlibTables.Operations._OclAny__oclIsKindOf;
			final @NonNull ExecutorType T_Type = OCLstdlibTables.Types._Type;
			final @NonNull ExecutorProperty P_TypedElement_type = PivotTables.Properties._TypedElement__type;
			final @NonNull LibraryProperty IP_TypedElement_type = P_TypedElement_type.getImplementation();
			...
			try {
				...
				Value A_symbol_407 = IP_CollectionLiteralExp_kind.evaluate(evaluator, T_pivot__CollectionKind, self, P_CollectionLiteralExp_kind);
				
				
				DomainType static_A_symbol_408 = valueFactory.typeOf(A_symbol_407, A_symbol_405);
				LibraryBinaryOperation dynamic_A_symbol_408 = (LibraryBinaryOperation)static_A_symbol_408.lookupImplementation(standardLibrary, O_OclAny__eq_);
				Value A_symbol_408 = dynamic_A_symbol_408.evaluate(evaluator, T_Boolean, A_symbol_407, A_symbol_405);
				leftA_symbol_406 = A_symbol_408;
			} catch (InvalidValueException e) {
				leftA_symbol_406 = valueFactory.createInvalidValue(e);
			}
			Value A_symbol_408 = leftA_symbol_406;
			Value rightA_symbol_406;
			try {
				
				Value A_symbol_409 = IP_TypedElement_type.evaluate(evaluator, T_Type, self, P_TypedElement_type);
				
				DomainType static_A_symbol_410 = valueFactory.typeOf(A_symbol_409);
				LibraryBinaryOperation dynamic_A_symbol_410 = (LibraryBinaryOperation)static_A_symbol_410.lookupImplementation(standardLibrary, O_OclAny_oclIsKindOf);
				Value A_symbol_410 = dynamic_A_symbol_410.evaluate(evaluator, T_Boolean, A_symbol_409, T_ClassClassifier_pivot__SetType_);
				rightA_symbol_406 = A_symbol_410;
			} catch (InvalidValueException e) {
				rightA_symbol_406 = valueFactory.createInvalidValue(e);
			}
			Value A_symbol_410 = rightA_symbol_406;
			DomainType static_A_symbol_406 = valueFactory.typeOf(A_symbol_408);
			...
			Value A_symbol_406 = dynamic_A_symbol_406.evaluate(evaluator, T_Boolean, A_symbol_408, A_symbol_410);
			return A_symbol_406;
		}
	}
