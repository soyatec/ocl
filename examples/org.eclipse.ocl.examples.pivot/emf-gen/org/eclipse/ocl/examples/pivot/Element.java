...
public interface Element
	 ...
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel body='/*\nnull\n\052/\ntry {\n\tfinal @<%org.eclipse.jdt.annotation.NonNull%> <%org.eclipse.ocl.examples.domain.evaluation.DomainEvaluator%> evaluator = new <%org.eclipse.ocl.examples.library.ecore.EcoreExecutorManager%>(this, <%org.eclipse.ocl.examples.pivot.PivotTables%>.LIBRARY);\n\tfinal @NonNull <%org.eclipse.ocl.examples.library.executor.ExecutorType%> T_OclVoid = <%org.eclipse.ocl.examples.library.oclstdlib.OCLstdlibTables%>.Types._OclVoid;\n\tfinal @NonNull <%org.eclipse.ocl.examples.domain.ids.TypeId%> returnTypeId = T_OclVoid.getTypeId();\n\tfinal @NonNull Object result = <%org.eclipse.ocl.examples.pivot.bodies.ElementBodies%>._getValue_body_.INSTANCE.evaluate(evaluator, returnTypeId, this, <%org.eclipse.ocl.examples.domain.values.util.ValuesUtil%>.valueOf(stereotype), <%org.eclipse.ocl.examples.domain.values.util.ValuesUtil%>.valueOf(propertyName));\n\treturn evaluator.asEcoreObject((Element)null, result);\n} catch (<%org.eclipse.ocl.examples.domain.evaluation.InvalidValueException%> e) {\n\tthrow new <%org.eclipse.emf.common.util.WrappedException%>(\"Failed to evaluate org.eclipse.ocl.examples.pivot.bodies.ElementBodies\", e);\n}\n'"
	 * @generated
	 */
