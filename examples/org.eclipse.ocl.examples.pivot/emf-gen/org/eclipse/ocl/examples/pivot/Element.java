...
public interface Element
	 ...
	 * <!-- end-user-doc -->
	 * @model ordered="false"
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel body='/*\noclContents()\n\052/\ntry {\n\tfinal @<%org.eclipse.jdt.annotation.NonNull%> <%org.eclipse.ocl.examples.domain.evaluation.DomainEvaluator%> evaluator = new <%org.eclipse.ocl.examples.library.ecore.EcoreExecutorManager%>(this, null, <%org.eclipse.ocl.examples.pivot.PivotTables%>.LIBRARY);\n\tfinal @NonNull <%org.eclipse.ocl.examples.domain.values.ValueFactory%> valueFactory = evaluator.getValueFactory();\n\tfinal @NonNull Object self = valueFactory.valueOf(this);\n\tfinal @NonNull <%org.eclipse.ocl.examples.domain.elements.DomainStandardLibrary%> standardLibrary = valueFactory.getStandardLibrary();\n\tfinal @NonNull <%org.eclipse.ocl.examples.library.executor.ExecutorType%> T_OclElement = <%org.eclipse.ocl.examples.library.oclstdlib.OCLstdlibTables%>.Types._OclElement;\n\tfinal @NonNull <%org.eclipse.ocl.examples.domain.elements.DomainCollectionType%> T_Set_OclElement_ = standardLibrary.getSetType(T_OclElement, null, null);\n\t\n\tfinal @NonNull <%org.eclipse.ocl.examples.domain.elements.DomainType%> returnType = T_Set_OclElement_;\n\tfinal @NonNull Object result = <%org.eclipse.ocl.examples.pivot.bodies.ElementBodies%>._allOwnedElements_body_.INSTANCE.evaluate(evaluator, returnType, self);\n\t@SuppressWarnings(\"unchecked\")\n\tEList<Element> ecoreResult = (EList<Element>) <%org.eclipse.ocl.examples.domain.values.util.ValuesUtil%>.asEcoreObject(result);\n\treturn ecoreResult;\n} catch (<%org.eclipse.ocl.examples.domain.evaluation.InvalidValueException%> e) {\n\tthrow new <%org.eclipse.emf.common.util.WrappedException%>(\"Failed to evaluate org.eclipse.ocl.examples.pivot.bodies.ElementBodies\", e);\n}\n'"
	 * @generated
	 */
	 ...
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel body='/*\nnull\n\052/\ntry {\n\tfinal @<%org.eclipse.jdt.annotation.NonNull%> <%org.eclipse.ocl.examples.domain.evaluation.DomainEvaluator%> evaluator = new <%org.eclipse.ocl.examples.library.ecore.EcoreExecutorManager%>(this, null, <%org.eclipse.ocl.examples.pivot.PivotTables%>.LIBRARY);\n\tfinal @NonNull <%org.eclipse.ocl.examples.domain.values.ValueFactory%> valueFactory = evaluator.getValueFactory();\n\tfinal @NonNull Object self = valueFactory.valueOf(this);\n\tfinal @NonNull <%org.eclipse.ocl.examples.library.executor.ExecutorType%> T_OclVoid = <%org.eclipse.ocl.examples.library.oclstdlib.OCLstdlibTables%>.Types._OclVoid;\n\t\n\tfinal @NonNull <%org.eclipse.ocl.examples.domain.elements.DomainType%> returnType = T_OclVoid;\n\tfinal @NonNull Object result = <%org.eclipse.ocl.examples.pivot.bodies.ElementBodies%>._getValue_body_.INSTANCE.evaluate(evaluator, returnType, self, valueFactory.valueOf(stereotype), valueFactory.valueOf(propertyName));\n\treturn (Element) <%org.eclipse.ocl.examples.domain.values.util.ValuesUtil%>.asEcoreObject(result);\n} catch (<%org.eclipse.ocl.examples.domain.evaluation.InvalidValueException%> e) {\n\tthrow new <%org.eclipse.emf.common.util.WrappedException%>(\"Failed to evaluate org.eclipse.ocl.examples.pivot.bodies.ElementBodies\", e);\n}\n'"
	 * @generated
	 */
