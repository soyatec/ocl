...
public class AbstractASResourceFactoryImpl extends ResourceFactoryImpl implements ASResource.Factory
{
	...
	public Resource createResource(URI uri) {
		ASResource result = new PivotResourceImpl(uri);
		result.setEncoding(ASResource.DEFAULT_ENCODING);
	    ...
	    result.getDefaultSaveOptions().put(XMLResource.OPTION_SCHEMA_LOCATION_IMPLEMENTATION, Boolean.TRUE);
	    return result;
	}
}
