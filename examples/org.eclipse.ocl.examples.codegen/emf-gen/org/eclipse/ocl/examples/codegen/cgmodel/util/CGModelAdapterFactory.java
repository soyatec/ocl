...
public class CGModelAdapterFactory extends AdapterFactoryImpl {
	...
	protected CGModelSwitch<Adapter> modelSwitch =
		new CGModelSwitch<Adapter>() {
			...
			@Override
			public Adapter caseCGComputedExp(CGComputedExp object) {
				return createCGComputedExpAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.ocl.examples.codegen.cgmodel.CGComputedExp <em>CG Computed Exp</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createCGComputedExpAdapter() {
		return null;
	}
