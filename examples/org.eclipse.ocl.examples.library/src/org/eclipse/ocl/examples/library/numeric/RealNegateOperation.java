...
/**
 * RealNegateOperation realises the unary -() library operation for reals.
 */
public class RealNegateOperation extends AbstractUnaryOperation
{
	public static final @NonNull RealNegateOperation INSTANCE = new RealNegateOperation();
