...
/**
	...
	public static class Types {
	    ...
	    public static final @NonNull EcoreExecutorType _OclInvalid = new EcoreExecutorInvalidType(TypeId.OCL_INVALID, PACKAGE, 0);
	...
	public static class Parameters {
		...
		public static final @NonNull DomainParameterTypes _Collection_1 = new DomainParameterTypes(new ExecutorSpecializedType(LIBRARY, "Collection", OCLstdlibTables.Operations.__Collection__product_T2));
		...
		public static final @NonNull DomainParameterTypes _Lambda_3 = new DomainParameterTypes(new ExecutorLambdaType(LIBRARY, "Lambda", OCLstdlibTables.Types._UniqueCollection_T));
		...
		public static final @NonNull DomainParameterTypes _Metaclass = new DomainParameterTypes(new ExecutorSpecializedType(LIBRARY, "Metaclass", OCLstdlibTables.Operations.__Collection__selectByType_TT));
		...
		public static final @NonNull DomainParameterTypes _Metaclass_15 = new DomainParameterTypes(new ExecutorSpecializedType(LIBRARY, "Metaclass", OCLstdlibTables.Operations.__UnlimitedNatural__oclAsType_TT));
		public static final @NonNull DomainParameterTypes _Metaclass_16 = new DomainParameterTypes(new ExecutorSpecializedType(LIBRARY, "Metaclass", OCLstdlibTables.Operations.__Sequence__selectByKind_TT));
		public static final @NonNull DomainParameterTypes _Metaclass_2 = new DomainParameterTypes(new ExecutorSpecializedType(LIBRARY, "Metaclass", OCLstdlibTables.Operations.__OclAny__oclAsType_TT));
		public static final @NonNull DomainParameterTypes _Metaclass_3 = new DomainParameterTypes(new ExecutorSpecializedType(LIBRARY, "Metaclass", OCLstdlibTables.Operations.__OclInvalid__oclIsTypeOf_T));
		public static final @NonNull DomainParameterTypes _Metaclass_4 = new DomainParameterTypes(new ExecutorSpecializedType(LIBRARY, "Metaclass", OCLstdlibTables.Operations.__Collection__selectByKind_TT));
		...
		public static final @NonNull DomainParameterTypes _Metaclass_8 = new DomainParameterTypes(new ExecutorSpecializedType(LIBRARY, "Metaclass", OCLstdlibTables.Operations.__OclInvalid__oclIsKindOf_T));
	...
	public static class Operations {
		...
		public static final @NonNull ExecutorOperation _Bag__collect = new ExecutorOperation("collect", Parameters._Lambda_5, Types._Bag,
		...
		public static final @NonNull ExecutorOperation _Collection__collectNested = new ExecutorOperation("collectNested", Parameters._Lambda_18, Types._Collection,
		...
		public static final @NonNull ExecutorOperation _Collection__product = new ExecutorOperation("product", Parameters._Collection_1, Types._Collection,
		...
		public static final @NonNull ExecutorOperation _Collection__selectByKind = new ExecutorOperation("selectByKind", Parameters._Metaclass_4, Types._Collection,
		...
		public static final @NonNull ExecutorOperation _Collection__selectByType = new ExecutorOperation("selectByType", Parameters._Metaclass, Types._Collection,
		...
		public static final @NonNull ExecutorOperation _OclAny__oclAsType = new ExecutorOperation("oclAsType", Parameters._Metaclass_2, Types._OclAny,
		...
		public static final @NonNull ExecutorOperation _OclInvalid__oclIsKindOf = new ExecutorOperation("oclIsKindOf", Parameters._Metaclass_8, Types._OclInvalid,
		...
		public static final @NonNull ExecutorOperation _Sequence__collect = new ExecutorOperation("collect", Parameters._Lambda_4, Types._Sequence,
		...
		public static final @NonNull ExecutorOperation _Sequence__collectNested = new ExecutorOperation("collectNested", Parameters._Lambda_12, Types._Sequence,
		...
		public static final @NonNull ExecutorOperation _Sequence__reject = new ExecutorOperation("reject", Parameters._Lambda_8, Types._Sequence,
		...
		public static final @NonNull ExecutorOperation _Sequence__select = new ExecutorOperation("select", Parameters._Lambda_8, Types._Sequence,
		...
		public static final @NonNull ExecutorOperation _Sequence__selectByKind = new ExecutorOperation("selectByKind", Parameters._Metaclass_16, Types._Sequence,
		...
		public static final @NonNull ExecutorOperation _Sequence__sortedBy = new ExecutorOperation("sortedBy", Parameters._Lambda_6, Types._Sequence,
		...
		public static final @NonNull ExecutorOperation _UniqueCollection___sub_ = new ExecutorOperation("-", Parameters._UniqueCollection, Types._UniqueCollection,
			0, DomainTypeParameters.EMPTY_LIST, org.eclipse.ocl.examples.library.collection.SetMinusOperation.INSTANCE);
		public static final @NonNull ExecutorOperation _UniqueCollection__sortedBy = new ExecutorOperation("sortedBy", Parameters._Lambda_3, Types._UniqueCollection,
		...
		public static final @NonNull ExecutorOperation _UnlimitedNatural__oclAsType = new ExecutorOperation("oclAsType", Parameters._Metaclass_15, Types._UnlimitedNatural,
