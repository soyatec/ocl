...
/**
	...
	public static class Types {
	    private static final @NonNull ExecutorTypeParameter _Bag_T = new ExecutorTypeParameter(LIBRARY, "T");
	    public static final @NonNull EcoreExecutorType _Bag = new EcoreExecutorType("Bag", PACKAGE, 0, _Bag_T);
	    public static final @NonNull EcoreExecutorType _Boolean = new EcoreExecutorType("Boolean", PACKAGE, 0);
	    public static final @NonNull EcoreExecutorType _Class = new EcoreExecutorType("Class", PACKAGE, 0);
	    private static final @NonNull ExecutorTypeParameter _Collection_T = new ExecutorTypeParameter(LIBRARY, "T");
	    public static final @NonNull EcoreExecutorType _Collection = new EcoreExecutorType("Collection", PACKAGE, 0, _Collection_T);
	    public static final @NonNull EcoreExecutorType _Enumeration = new EcoreExecutorType("Enumeration", PACKAGE, 0);
	    public static final @NonNull EcoreExecutorType _EnumerationLiteral = new EcoreExecutorType("EnumerationLiteral", PACKAGE, 0);
	    public static final @NonNull EcoreExecutorType _Integer = new EcoreExecutorType("Integer", PACKAGE, 0);
	    private static final @NonNull ExecutorTypeParameter _Metaclass_T = new ExecutorTypeParameter(LIBRARY, "T");
	    public static final @NonNull EcoreExecutorType _Metaclass = new EcoreExecutorType("Metaclass", PACKAGE, 0, _Metaclass_T);
	    public static final @NonNull EcoreExecutorType _OclAny = new EcoreExecutorType("OclAny", PACKAGE, 0);
	    ...
	    public static final @NonNull EcoreExecutorType _OclInvalid = new EcoreExecutorType("OclInvalid", PACKAGE, 0);
	    ...
	    public static final @NonNull EcoreExecutorType _OclVoid = new EcoreExecutorType("OclVoid", PACKAGE, 0);
	    private static final @NonNull ExecutorTypeParameter _OrderedSet_T = new ExecutorTypeParameter(LIBRARY, "T");
	    public static final @NonNull EcoreExecutorType _OrderedSet = new EcoreExecutorType("OrderedSet", PACKAGE, ExecutorType.ORDERED | ExecutorType.UNIQUE, _OrderedSet_T);
	    public static final @NonNull EcoreExecutorType _Real = new EcoreExecutorType("Real", PACKAGE, 0);
	    private static final @NonNull ExecutorTypeParameter _Sequence_T = new ExecutorTypeParameter(LIBRARY, "T");
	    public static final @NonNull EcoreExecutorType _Sequence = new EcoreExecutorType("Sequence", PACKAGE, ExecutorType.ORDERED, _Sequence_T);
	    private static final @NonNull ExecutorTypeParameter _Set_T = new ExecutorTypeParameter(LIBRARY, "T");
	    public static final @NonNull EcoreExecutorType _Set = new EcoreExecutorType("Set", PACKAGE, ExecutorType.UNIQUE, _Set_T);
	    public static final @NonNull EcoreExecutorType _String = new EcoreExecutorType("String", PACKAGE, 0);
	    public static final @NonNull EcoreExecutorType _Type = new EcoreExecutorType("Type", PACKAGE, 0);
	    private static final @NonNull ExecutorTypeParameter _UniqueCollection_T = new ExecutorTypeParameter(LIBRARY, "T");
	    public static final @NonNull EcoreExecutorType _UniqueCollection = new EcoreExecutorType("UniqueCollection", PACKAGE, 0, _UniqueCollection_T);
	    public static final @NonNull EcoreExecutorType _UnlimitedNatural = new EcoreExecutorType("UnlimitedNatural", PACKAGE, 0);
	    public static final @NonNull EcoreExecutorType __Dummy = new EcoreExecutorType("_Dummy", PACKAGE, 0);
	...
	public static class Fragments {
		...
		public static final @NonNull ExecutorFragment _Class__Class = new ExecutorFragment(Types._Class, OCLstdlibTables.Types._Class);
		...
		public static final @NonNull ExecutorFragment _Enumeration__Enumeration = new ExecutorFragment(Types._Enumeration, OCLstdlibTables.Types._Enumeration);
		...
		public static final @NonNull ExecutorFragment _EnumerationLiteral__EnumerationLiteral = new ExecutorFragment(Types._EnumerationLiteral, OCLstdlibTables.Types._EnumerationLiteral);
		...
		public static final @NonNull ExecutorFragment _Metaclass__Class = new ExecutorFragment(Types._Metaclass, OCLstdlibTables.Types._Class);
		public static final @NonNull ExecutorFragment _Metaclass__Metaclass = new ExecutorFragment(Types._Metaclass, OCLstdlibTables.Types._Metaclass);
		...
		public static final @NonNull ExecutorFragment _Type__Type = new ExecutorFragment(Types._Type, OCLstdlibTables.Types._Type);
	...
	public static class Parameters {
		...
		public static final @NonNull DomainParameterTypes _Collection = new DomainParameterTypes(new ExecutorSpecializedType(LIBRARY, "Collection", OCLstdlibTables.Types._OrderedSet_T));
		...
		public static final @NonNull DomainParameterTypes _Collection_2 = new DomainParameterTypes(new ExecutorSpecializedType(LIBRARY, "Collection", OCLstdlibTables.Types._UniqueCollection_T));
		...
		public static final @NonNull DomainParameterTypes _Collection_4 = new DomainParameterTypes(new ExecutorSpecializedType(LIBRARY, "Collection", OCLstdlibTables.Types._Bag_T));
		public static final @NonNull DomainParameterTypes _Collection_5 = new DomainParameterTypes(new ExecutorSpecializedType(LIBRARY, "Collection", OCLstdlibTables.Types._Set_T));
		public static final @NonNull DomainParameterTypes _Collection_6 = new DomainParameterTypes(new ExecutorSpecializedType(LIBRARY, "Collection", OCLstdlibTables.Operations.__Collection__includesAll_T2));
		...
		public static final @NonNull DomainParameterTypes _Lambda_15 = new DomainParameterTypes(new ExecutorLambdaType(LIBRARY, "Lambda", OCLstdlibTables.Types._UniqueCollection_T));
		public static final @NonNull DomainParameterTypes _Lambda_16 = new DomainParameterTypes(new ExecutorLambdaType(LIBRARY, "Lambda", OCLstdlibTables.Types._OrderedSet_T));
		...
		public static final @NonNull DomainParameterTypes _Lambda_2 = new DomainParameterTypes(new ExecutorLambdaType(LIBRARY, "Lambda", OCLstdlibTables.Types._Sequence_T));
		...
		public static final @NonNull DomainParameterTypes _Lambda_5 = new DomainParameterTypes(new ExecutorLambdaType(LIBRARY, "Lambda", OCLstdlibTables.Types._Bag_T));
		public static final @NonNull DomainParameterTypes _Lambda_6 = new DomainParameterTypes(new ExecutorLambdaType(LIBRARY, "Lambda", OCLstdlibTables.Types._Sequence_T));
		...
		public static final @NonNull DomainParameterTypes _Lambda_9 = new DomainParameterTypes(new ExecutorLambdaType(LIBRARY, "Lambda", OCLstdlibTables.Types._Set_T));
		...
		public static final @NonNull DomainParameterTypes _Metaclass_1 = new DomainParameterTypes(new ExecutorSpecializedType(LIBRARY, "Metaclass", OCLstdlibTables.Operations.__OclAny__oclIsTypeOf_T));
		public static final @NonNull DomainParameterTypes _Metaclass_10 = new DomainParameterTypes(new ExecutorSpecializedType(LIBRARY, "Metaclass", OCLstdlibTables.Operations.__Collection__selectByKind_TT));
		public static final @NonNull DomainParameterTypes _Metaclass_11 = new DomainParameterTypes(new ExecutorSpecializedType(LIBRARY, "Metaclass", OCLstdlibTables.Operations.__Set__selectByKind_TT));
		public static final @NonNull DomainParameterTypes _Metaclass_12 = new DomainParameterTypes(new ExecutorSpecializedType(LIBRARY, "Metaclass", OCLstdlibTables.Operations.__Bag__selectByType_TT));
		public static final @NonNull DomainParameterTypes _Metaclass_13 = new DomainParameterTypes(new ExecutorSpecializedType(LIBRARY, "Metaclass", OCLstdlibTables.Operations.__Collection__selectByType_TT));
		public static final @NonNull DomainParameterTypes _Metaclass_2 = new DomainParameterTypes(new ExecutorSpecializedType(LIBRARY, "Metaclass", OCLstdlibTables.Operations.__Set__selectByType_TT));
		public static final @NonNull DomainParameterTypes _Metaclass_3 = new DomainParameterTypes(new ExecutorSpecializedType(LIBRARY, "Metaclass", OCLstdlibTables.Operations.__OclAny__oclIsKindOf_T));
		...
		public static final @NonNull DomainParameterTypes _Metaclass_5 = new DomainParameterTypes(new ExecutorSpecializedType(LIBRARY, "Metaclass", OCLstdlibTables.Operations.__UnlimitedNatural__oclAsType_TT));
		...
		public static final @NonNull DomainParameterTypes _Metaclass_7 = new DomainParameterTypes(new ExecutorSpecializedType(LIBRARY, "Metaclass", OCLstdlibTables.Operations.__Sequence__selectByType_TT));
		...
		public static final @NonNull DomainParameterTypes _Metaclass_9 = new DomainParameterTypes(new ExecutorSpecializedType(LIBRARY, "Metaclass", OCLstdlibTables.Operations.__OrderedSet__selectByKind_TT));
		...
		public static final @NonNull DomainParameterTypes _T_1 = new DomainParameterTypes(OCLstdlibTables.Types._Bag_T);
		public static final @NonNull DomainParameterTypes _T_2 = new DomainParameterTypes(OCLstdlibTables.Types._Sequence_T);
		public static final @NonNull DomainParameterTypes _T_3 = new DomainParameterTypes(OCLstdlibTables.Types._Set_T);
		public static final @NonNull DomainParameterTypes _T_4 = new DomainParameterTypes(OCLstdlibTables.Types._Collection_T);
		public static final @NonNull DomainParameterTypes _UniqueCollection = new DomainParameterTypes(new ExecutorSpecializedType(LIBRARY, "UniqueCollection", OCLstdlibTables.Types._OclAny));
		public static final @NonNull DomainParameterTypes _UniqueCollection_1 = new DomainParameterTypes(new ExecutorSpecializedType(LIBRARY, "UniqueCollection", OCLstdlibTables.Types._Sequence_T));
	...
	public static class Operations {
		...
		public static final @NonNull ExecutorOperation _Bag__closure = new ExecutorOperation("closure", Parameters._Lambda_14, Types._Bag,
		...
		public static final @NonNull ExecutorOperation _Bag__collect = new ExecutorOperation("collect", Parameters._Lambda_3, Types._Bag,
		...
		public static final @NonNull ExecutorOperation _Bag__collectNested = new ExecutorOperation("collectNested", Parameters._Lambda_1, Types._Bag,
		...
		public static final @NonNull ExecutorOperation _Bag__including = new ExecutorOperation("including", Parameters._T_1, Types._Bag,
			7, DomainTypeParameters.EMPTY_LIST, org.eclipse.ocl.examples.library.collection.CollectionIncludingOperation.INSTANCE);
		public static final @NonNull ExecutorOperation _Bag__0_intersection = new ExecutorOperation("intersection", Parameters._Collection_4, Types._Bag,
		...
		public static final @NonNull ExecutorOperation _Bag__reject = new ExecutorOperation("reject", Parameters._Lambda_5, Types._Bag,
			10, DomainTypeParameters.EMPTY_LIST, org.eclipse.ocl.examples.library.iterator.RejectIteration.INSTANCE);
		public static final @NonNull ExecutorOperation _Bag__select = new ExecutorOperation("select", Parameters._Lambda_5, Types._Bag,
		...
		public static final @NonNull ExecutorOperation _Bag__selectByType = new ExecutorOperation("selectByType", Parameters._Metaclass_12, Types._Bag,
		...
		public static final @NonNull ExecutorOperation _Bag__sortedBy = new ExecutorOperation("sortedBy", Parameters._Lambda_4, Types._Bag,
			14, DomainTypeParameters.EMPTY_LIST, org.eclipse.ocl.examples.library.iterator.SortedByIteration.INSTANCE);
		public static final @NonNull ExecutorOperation _Bag__0_union = new ExecutorOperation("union", Parameters._Collection_4, Types._Bag,
		...
		public static final @NonNull ExecutorOperation _Collection__collect = new ExecutorOperation("collect", Parameters._Lambda, Types._Collection,
		...
		public static final @NonNull ExecutorOperation _Collection__collectNested = new ExecutorOperation("collectNested", Parameters._Lambda_8, Types._Collection,
		...
		public static final @NonNull ExecutorOperation _Collection__includesAll = new ExecutorOperation("includesAll", Parameters._Collection_6, Types._Collection,
		...
		public static final @NonNull ExecutorOperation _Collection__isUnique = new ExecutorOperation("isUnique", Parameters._Lambda_7, Types._Collection,
		...
		public static final @NonNull ExecutorOperation _Collection__iterate = new ExecutorOperation("iterate", Parameters._Lambda_12, Types._Collection,
		...
		public static final @NonNull ExecutorOperation _Collection__selectByKind = new ExecutorOperation("selectByKind", Parameters._Metaclass_10, Types._Collection,
		...
		public static final @NonNull ExecutorOperation _Collection__selectByType = new ExecutorOperation("selectByType", Parameters._Metaclass_13, Types._Collection,
		...
		public static final @NonNull ExecutorOperation _Collection__sortedBy = new ExecutorOperation("sortedBy", Parameters._Lambda_7, Types._Collection,
		...
		public static final @NonNull ExecutorOperation _OclAny__oclIsKindOf = new ExecutorOperation("oclIsKindOf", Parameters._Metaclass_3, Types._OclAny,
		...
		public static final @NonNull ExecutorOperation _OclAny__oclIsTypeOf = new ExecutorOperation("oclIsTypeOf", Parameters._Metaclass_1, Types._OclAny,
		...
		public static final @NonNull ExecutorOperation _OclInvalid__allInstances = new ExecutorOperation("allInstances", Parameters._, Types._OclInvalid,
			2, DomainTypeParameters.EMPTY_LIST, org.eclipse.ocl.examples.library.oclinvalid.OclInvalidAllInstancesOperation.INSTANCE);
		...
		public static final @NonNull ExecutorOperation _OclInvalid__toString = new ExecutorOperation("toString", Parameters._, Types._OclInvalid,
			4, DomainTypeParameters.EMPTY_LIST, org.eclipse.ocl.examples.library.oclany.OclAnyToStringOperation.INSTANCE);
		...
		public static final @NonNull ExecutorOperation _OrderedSet__intersection = new ExecutorOperation("intersection", Parameters._Collection, Types._OrderedSet,
			8, DomainTypeParameters.EMPTY_LIST, org.eclipse.ocl.examples.library.collection.CollectionIntersectionOperation.INSTANCE);
		...
		public static final @NonNull ExecutorOperation _OrderedSet__reject = new ExecutorOperation("reject", Parameters._Lambda_16, Types._OrderedSet,
			10, DomainTypeParameters.EMPTY_LIST, org.eclipse.ocl.examples.library.iterator.RejectIteration.INSTANCE);
		...
		public static final @NonNull ExecutorOperation _OrderedSet__select = new ExecutorOperation("select", Parameters._Lambda_16, Types._OrderedSet,
		...
		public static final @NonNull ExecutorOperation _OrderedSet__selectByKind = new ExecutorOperation("selectByKind", Parameters._Metaclass_9, Types._OrderedSet,
		...
		public static final @NonNull ExecutorOperation _OrderedSet__sortedBy = new ExecutorOperation("sortedBy", Parameters._Lambda_13, Types._OrderedSet,
		...
		public static final @NonNull ExecutorOperation _Sequence__closure = new ExecutorOperation("closure", Parameters._Lambda_11, Types._Sequence,
		...
		public static final @NonNull ExecutorOperation _Sequence__collectNested = new ExecutorOperation("collectNested", Parameters._Lambda_6, Types._Sequence,
		...
		public static final @NonNull ExecutorOperation _Sequence__1_intersection = new ExecutorOperation("intersection", Parameters._UniqueCollection_1, Types._Sequence,
		...
		public static final @NonNull ExecutorOperation _Sequence__reject = new ExecutorOperation("reject", Parameters._Lambda_2, Types._Sequence,
		...
		public static final @NonNull ExecutorOperation _Sequence__select = new ExecutorOperation("select", Parameters._Lambda_2, Types._Sequence,
		...
		public static final @NonNull ExecutorOperation _Sequence__selectByType = new ExecutorOperation("selectByType", Parameters._Metaclass_7, Types._Sequence,
		...
		public static final @NonNull ExecutorOperation _Set__including = new ExecutorOperation("including", Parameters._T_3, Types._Set,
			5, DomainTypeParameters.EMPTY_LIST, org.eclipse.ocl.examples.library.collection.CollectionIncludingOperation.INSTANCE);
		public static final @NonNull ExecutorOperation _Set__intersection = new ExecutorOperation("intersection", Parameters._Collection_5, Types._Set,
			6, DomainTypeParameters.EMPTY_LIST, org.eclipse.ocl.examples.library.collection.CollectionIntersectionOperation.INSTANCE);
		public static final @NonNull ExecutorOperation _Set__reject = new ExecutorOperation("reject", Parameters._Lambda_10, Types._Set,
			7, DomainTypeParameters.EMPTY_LIST, org.eclipse.ocl.examples.library.iterator.RejectIteration.INSTANCE);
		public static final @NonNull ExecutorOperation _Set__select = new ExecutorOperation("select", Parameters._Lambda_10, Types._Set,
		...
		public static final @NonNull ExecutorOperation _Set__selectByType = new ExecutorOperation("selectByType", Parameters._Metaclass_2, Types._Set,
		...
		public static final @NonNull ExecutorOperation _Set__sortedBy = new ExecutorOperation("sortedBy", Parameters._Lambda_9, Types._Set,
			11, DomainTypeParameters.EMPTY_LIST, org.eclipse.ocl.examples.library.iterator.SortedByIteration.INSTANCE);
		public static final @NonNull ExecutorOperation _Set__union = new ExecutorOperation("union", Parameters._Collection_5, Types._Set,
		...
		public static final @NonNull ExecutorOperation _UniqueCollection___sub_ = new ExecutorOperation("-", Parameters._UniqueCollection, Types._UniqueCollection,
			0, DomainTypeParameters.EMPTY_LIST, org.eclipse.ocl.examples.library.collection.SetMinusOperation.INSTANCE);
		public static final @NonNull ExecutorOperation _UniqueCollection__sortedBy = new ExecutorOperation("sortedBy", Parameters._Lambda_15, Types._UniqueCollection,
		...
		public static final @NonNull ExecutorOperation _UniqueCollection__union = new ExecutorOperation("union", Parameters._Collection_2, Types._UniqueCollection,
		...
		public static final @NonNull ExecutorOperation _UnlimitedNatural__oclAsType = new ExecutorOperation("oclAsType", Parameters._Metaclass_5, Types._UnlimitedNatural,
	...
	public static class TypeFragments {
		...
		private static final @NonNull int[] __Class = { 1,1 };
		...
		private static final @NonNull int[] __Enumeration = { 1,1 };
		...
		private static final @NonNull int[] __EnumerationLiteral = { 1,1 };
		...
		private static final @NonNull ExecutorFragment[] _Metaclass =
		{
		    ...
		    Fragments._Metaclass__Class /* 1 */,
		    Fragments._Metaclass__OclElement /* 1 */,
		    Fragments._Metaclass__OclType /* 2 */,
		    Fragments._Metaclass__Metaclass /* 3 */
		};
		private static final @NonNull int[] __Metaclass = { 1,2,1,1 };
		...
		private static final @NonNull int[] __Type = { 1,1,1,1 };
	...
	public static class FragmentProperties {
		...
		private static final @NonNull ExecutorProperty[] __Dummy = {};
