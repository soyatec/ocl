...
/**
	...
	public static class TypeParameters {
		public static final @NonNull ExecutorTypeParameter _Bag_T = new ExecutorTypeParameter(TypeId.BAG_T, LIBRARY, "T");
		...
		public static final @NonNull ExecutorTypeParameter _Collection_T = new ExecutorTypeParameter(TypeId.COLLECTION_T, LIBRARY, "T");
		...
		public static final @NonNull ExecutorTypeParameter _OrderedSet_T = new ExecutorTypeParameter(TypeId.ORDERED_SET_T, LIBRARY, "T");
		...
		public static final @NonNull ExecutorTypeParameter _Sequence_T = new ExecutorTypeParameter(TypeId.SEQUENCE_T, LIBRARY, "T");
		...
		public static final @NonNull ExecutorTypeParameter _Set_T = new ExecutorTypeParameter(TypeId.SET_T, LIBRARY, "T");
		...
		public static final @NonNull ExecutorTypeParameter _UniqueCollection_T = new ExecutorTypeParameter(TypeId.UNIQUE_COLLECTION_T, LIBRARY, "T");
	...
	public static class Parameters {
		public static final @NonNull DomainParameterTypes _ = new DomainParameterTypes(); //_
		public static final @NonNull DomainParameterTypes _Boolean = new DomainParameterTypes(OCLstdlibTables.Types._Boolean); //_Boolean
		public static final @NonNull DomainParameterTypes _Collection = new DomainParameterTypes(new ExecutorSpecializedType(LIBRARY, "Collection", OCLstdlibTables.TypeParameters._UniqueCollection_T)); //_Collection
		public static final @NonNull DomainParameterTypes _Collection_1 = new DomainParameterTypes(new ExecutorSpecializedType(LIBRARY, "Collection", OCLstdlibTables.TypeParameters.__Collection__includesAll_T2)); //_Collection_1
		public static final @NonNull DomainParameterTypes _Collection_2 = new DomainParameterTypes(new ExecutorSpecializedType(LIBRARY, "Collection", OCLstdlibTables.TypeParameters.__Collection__excludesAll_T2)); //_Collection_2
		public static final @NonNull DomainParameterTypes _Collection_3 = new DomainParameterTypes(new ExecutorSpecializedType(LIBRARY, "Collection", OCLstdlibTables.TypeParameters._Bag_T)); //_Collection_3
		public static final @NonNull DomainParameterTypes _Collection_4 = new DomainParameterTypes(new ExecutorSpecializedType(LIBRARY, "Collection", OCLstdlibTables.TypeParameters._OrderedSet_T)); //_Collection_4
		public static final @NonNull DomainParameterTypes _Collection_5 = new DomainParameterTypes(new ExecutorSpecializedType(LIBRARY, "Collection", OCLstdlibTables.TypeParameters._Sequence_T)); //_Collection_5
		public static final @NonNull DomainParameterTypes _Collection_6 = new DomainParameterTypes(new ExecutorSpecializedType(LIBRARY, "Collection", OCLstdlibTables.TypeParameters.__Collection__product_T2)); //_Collection_6
		public static final @NonNull DomainParameterTypes _Collection_7 = new DomainParameterTypes(new ExecutorSpecializedType(LIBRARY, "Collection", OCLstdlibTables.TypeParameters._Set_T)); //_Collection_7
		public static final @NonNull DomainParameterTypes _Integer = new DomainParameterTypes(OCLstdlibTables.Types._Integer); //_Integer
		public static final @NonNull DomainParameterTypes _Integer_Integer = new DomainParameterTypes(OCLstdlibTables.Types._Integer, OCLstdlibTables.Types._Integer); //_Integer_Integer
		public static final @NonNull DomainParameterTypes _Integer_T = new DomainParameterTypes(OCLstdlibTables.Types._Integer, OCLstdlibTables.TypeParameters._Sequence_T); //_Integer_T
		public static final @NonNull DomainParameterTypes _Integer_T_1 = new DomainParameterTypes(OCLstdlibTables.Types._Integer, OCLstdlibTables.TypeParameters._OrderedSet_T); //_Integer_T_1
		public static final @NonNull DomainParameterTypes _Lambda = new DomainParameterTypes(new ExecutorLambdaType(LIBRARY, "Lambda", OCLstdlibTables.TypeParameters._UniqueCollection_T)); //_Lambda
		public static final @NonNull DomainParameterTypes _Lambda_1 = new DomainParameterTypes(new ExecutorLambdaType(LIBRARY, "Lambda", OCLstdlibTables.TypeParameters._Collection_T)); //_Lambda_1
		public static final @NonNull DomainParameterTypes _Lambda_10 = new DomainParameterTypes(new ExecutorLambdaType(LIBRARY, "Lambda", OCLstdlibTables.TypeParameters._Sequence_T)); //_Lambda_10
		public static final @NonNull DomainParameterTypes _Lambda_11 = new DomainParameterTypes(new ExecutorLambdaType(LIBRARY, "Lambda", OCLstdlibTables.TypeParameters._Bag_T)); //_Lambda_11
		public static final @NonNull DomainParameterTypes _Lambda_12 = new DomainParameterTypes(new ExecutorLambdaType(LIBRARY, "Lambda", OCLstdlibTables.TypeParameters._Bag_T)); //_Lambda_12
		public static final @NonNull DomainParameterTypes _Lambda_13 = new DomainParameterTypes(new ExecutorLambdaType(LIBRARY, "Lambda", OCLstdlibTables.TypeParameters._Set_T)); //_Lambda_13
		public static final @NonNull DomainParameterTypes _Lambda_14 = new DomainParameterTypes(new ExecutorLambdaType(LIBRARY, "Lambda", OCLstdlibTables.TypeParameters._Bag_T)); //_Lambda_14
		public static final @NonNull DomainParameterTypes _Lambda_15 = new DomainParameterTypes(new ExecutorLambdaType(LIBRARY, "Lambda", OCLstdlibTables.TypeParameters._Sequence_T)); //_Lambda_15
		public static final @NonNull DomainParameterTypes _Lambda_16 = new DomainParameterTypes(new ExecutorLambdaType(LIBRARY, "Lambda", OCLstdlibTables.TypeParameters._Sequence_T)); //_Lambda_16
		public static final @NonNull DomainParameterTypes _Lambda_17 = new DomainParameterTypes(new ExecutorLambdaType(LIBRARY, "Lambda", OCLstdlibTables.TypeParameters._Sequence_T)); //_Lambda_17
		public static final @NonNull DomainParameterTypes _Lambda_18 = new DomainParameterTypes(new ExecutorLambdaType(LIBRARY, "Lambda", OCLstdlibTables.TypeParameters._Bag_T)); //_Lambda_18
		public static final @NonNull DomainParameterTypes _Lambda_19 = new DomainParameterTypes(new ExecutorLambdaType(LIBRARY, "Lambda", OCLstdlibTables.TypeParameters._Collection_T)); //_Lambda_19
		public static final @NonNull DomainParameterTypes _Lambda_2 = new DomainParameterTypes(new ExecutorLambdaType(LIBRARY, "Lambda", OCLstdlibTables.TypeParameters._Collection_T)); //_Lambda_2
		public static final @NonNull DomainParameterTypes _Lambda_3 = new DomainParameterTypes(new ExecutorLambdaType(LIBRARY, "Lambda", OCLstdlibTables.TypeParameters._Bag_T)); //_Lambda_3
		public static final @NonNull DomainParameterTypes _Lambda_4 = new DomainParameterTypes(new ExecutorLambdaType(LIBRARY, "Lambda", OCLstdlibTables.TypeParameters._Set_T)); //_Lambda_4
		public static final @NonNull DomainParameterTypes _Lambda_5 = new DomainParameterTypes(new ExecutorLambdaType(LIBRARY, "Lambda", OCLstdlibTables.TypeParameters._Sequence_T)); //_Lambda_5
		public static final @NonNull DomainParameterTypes _Lambda_6 = new DomainParameterTypes(new ExecutorLambdaType(LIBRARY, "Lambda", OCLstdlibTables.TypeParameters._OrderedSet_T)); //_Lambda_6
		public static final @NonNull DomainParameterTypes _Lambda_7 = new DomainParameterTypes(new ExecutorLambdaType(LIBRARY, "Lambda", OCLstdlibTables.TypeParameters._Collection_T)); //_Lambda_7
		public static final @NonNull DomainParameterTypes _Lambda_8 = new DomainParameterTypes(new ExecutorLambdaType(LIBRARY, "Lambda", OCLstdlibTables.TypeParameters._Collection_T)); //_Lambda_8
		public static final @NonNull DomainParameterTypes _Lambda_9 = new DomainParameterTypes(new ExecutorLambdaType(LIBRARY, "Lambda", OCLstdlibTables.TypeParameters._OrderedSet_T)); //_Lambda_9
		public static final @NonNull DomainParameterTypes _Metaclass = new DomainParameterTypes(new ExecutorSpecializedType(LIBRARY, "Metaclass", OCLstdlibTables.TypeParameters.__OclAny__oclIsTypeOf_T)); //_Metaclass
		public static final @NonNull DomainParameterTypes _Metaclass_1 = new DomainParameterTypes(new ExecutorSpecializedType(LIBRARY, "Metaclass", OCLstdlibTables.TypeParameters.__Bag__selectByType_TT)); //_Metaclass_1
		public static final @NonNull DomainParameterTypes _Metaclass_10 = new DomainParameterTypes(new ExecutorSpecializedType(LIBRARY, "Metaclass", OCLstdlibTables.TypeParameters.__OrderedSet__selectByKind_TT)); //_Metaclass_10
		public static final @NonNull DomainParameterTypes _Metaclass_11 = new DomainParameterTypes(new ExecutorSpecializedType(LIBRARY, "Metaclass", OCLstdlibTables.TypeParameters.__Set__selectByKind_TT)); //_Metaclass_11
		public static final @NonNull DomainParameterTypes _Metaclass_12 = new DomainParameterTypes(new ExecutorSpecializedType(LIBRARY, "Metaclass", OCLstdlibTables.TypeParameters.__Sequence__selectByKind_TT)); //_Metaclass_12
		public static final @NonNull DomainParameterTypes _Metaclass_13 = new DomainParameterTypes(new ExecutorSpecializedType(LIBRARY, "Metaclass", OCLstdlibTables.TypeParameters.__Set__selectByType_TT)); //_Metaclass_13
		public static final @NonNull DomainParameterTypes _Metaclass_14 = new DomainParameterTypes(new ExecutorSpecializedType(LIBRARY, "Metaclass", OCLstdlibTables.TypeParameters.__Sequence__selectByType_TT)); //_Metaclass_14
		public static final @NonNull DomainParameterTypes _Metaclass_15 = new DomainParameterTypes(new ExecutorSpecializedType(LIBRARY, "Metaclass", OCLstdlibTables.TypeParameters.__Collection__selectByKind_TT)); //_Metaclass_15
		public static final @NonNull DomainParameterTypes _Metaclass_16 = new DomainParameterTypes(new ExecutorSpecializedType(LIBRARY, "Metaclass", OCLstdlibTables.TypeParameters.__Bag__selectByKind_TT)); //_Metaclass_16
		public static final @NonNull DomainParameterTypes _Metaclass_2 = new DomainParameterTypes(new ExecutorSpecializedType(LIBRARY, "Metaclass", OCLstdlibTables.TypeParameters.__OclInvalid__oclAsType_TT)); //_Metaclass_2
		public static final @NonNull DomainParameterTypes _Metaclass_3 = new DomainParameterTypes(new ExecutorSpecializedType(LIBRARY, "Metaclass", OCLstdlibTables.TypeParameters.__OclInvalid__oclIsTypeOf_T)); //_Metaclass_3
		public static final @NonNull DomainParameterTypes _Metaclass_4 = new DomainParameterTypes(new ExecutorSpecializedType(LIBRARY, "Metaclass", OCLstdlibTables.TypeParameters.__UnlimitedNatural__oclAsType_TT)); //_Metaclass_4
		public static final @NonNull DomainParameterTypes _Metaclass_5 = new DomainParameterTypes(new ExecutorSpecializedType(LIBRARY, "Metaclass", OCLstdlibTables.TypeParameters.__OclInvalid__oclIsKindOf_T)); //_Metaclass_5
		public static final @NonNull DomainParameterTypes _Metaclass_6 = new DomainParameterTypes(new ExecutorSpecializedType(LIBRARY, "Metaclass", OCLstdlibTables.TypeParameters.__OclAny__oclIsKindOf_T)); //_Metaclass_6
		public static final @NonNull DomainParameterTypes _Metaclass_7 = new DomainParameterTypes(new ExecutorSpecializedType(LIBRARY, "Metaclass", OCLstdlibTables.TypeParameters.__Collection__selectByType_TT)); //_Metaclass_7
		public static final @NonNull DomainParameterTypes _Metaclass_8 = new DomainParameterTypes(new ExecutorSpecializedType(LIBRARY, "Metaclass", OCLstdlibTables.TypeParameters.__OrderedSet__selectByType_TT)); //_Metaclass_8
		public static final @NonNull DomainParameterTypes _Metaclass_9 = new DomainParameterTypes(new ExecutorSpecializedType(LIBRARY, "Metaclass", OCLstdlibTables.TypeParameters.__OclAny__oclAsType_TT)); //_Metaclass_9
		public static final @NonNull DomainParameterTypes _OclAny = new DomainParameterTypes(OCLstdlibTables.Types._OclAny); //_OclAny
		public static final @NonNull DomainParameterTypes _OclSelf = new DomainParameterTypes(OCLstdlibTables.Types._OclSelf); //_OclSelf
		public static final @NonNull DomainParameterTypes _OclState = new DomainParameterTypes(OCLstdlibTables.Types._OclState); //_OclState
		public static final @NonNull DomainParameterTypes _OclType = new DomainParameterTypes(OCLstdlibTables.Types._OclType); //_OclType
		public static final @NonNull DomainParameterTypes _Sequence = new DomainParameterTypes(new ExecutorSpecializedType(LIBRARY, "Sequence", OCLstdlibTables.TypeParameters._Sequence_T)); //_Sequence
		public static final @NonNull DomainParameterTypes _Sequence_1 = new DomainParameterTypes(new ExecutorSpecializedType(LIBRARY, "Sequence", OCLstdlibTables.TypeParameters._OrderedSet_T)); //_Sequence_1
		public static final @NonNull DomainParameterTypes _String = new DomainParameterTypes(OCLstdlibTables.Types._String); //_String
		public static final @NonNull DomainParameterTypes _String_Boolean = new DomainParameterTypes(OCLstdlibTables.Types._String, OCLstdlibTables.Types._Boolean); //_String_Boolean
		public static final @NonNull DomainParameterTypes _String_String = new DomainParameterTypes(OCLstdlibTables.Types._String, OCLstdlibTables.Types._String); //_String_String
		public static final @NonNull DomainParameterTypes _T = new DomainParameterTypes(OCLstdlibTables.TypeParameters._OrderedSet_T); //_T
		public static final @NonNull DomainParameterTypes _T_1 = new DomainParameterTypes(OCLstdlibTables.TypeParameters._Set_T); //_T_1
		public static final @NonNull DomainParameterTypes _T_2 = new DomainParameterTypes(OCLstdlibTables.TypeParameters._Sequence_T); //_T_2
		public static final @NonNull DomainParameterTypes _T_3 = new DomainParameterTypes(OCLstdlibTables.TypeParameters._Bag_T); //_T_3
		public static final @NonNull DomainParameterTypes _T_4 = new DomainParameterTypes(OCLstdlibTables.TypeParameters._Collection_T); //_T_4
		public static final @NonNull DomainParameterTypes _UniqueCollection = new DomainParameterTypes(new ExecutorSpecializedType(LIBRARY, "UniqueCollection", OCLstdlibTables.Types._OclAny)); //_UniqueCollection
		public static final @NonNull DomainParameterTypes _UniqueCollection_1 = new DomainParameterTypes(new ExecutorSpecializedType(LIBRARY, "UniqueCollection", OCLstdlibTables.TypeParameters._Bag_T)); //_UniqueCollection_1
		public static final @NonNull DomainParameterTypes _UniqueCollection_2 = new DomainParameterTypes(new ExecutorSpecializedType(LIBRARY, "UniqueCollection", OCLstdlibTables.TypeParameters._Sequence_T)); //_UniqueCollection_2
	}
	...
	public static class Operations {
		...
		public static final @NonNull ExecutorOperation _Bag__closure = new ExecutorOperation("closure", Parameters._Lambda_11, Types._Bag,
			2, DomainTypeParameters.EMPTY_LIST, org.eclipse.ocl.examples.library.iterator.ClosureIteration.INSTANCE);
		public static final @NonNull ExecutorOperation _Bag__collect = new ExecutorOperation("collect", Parameters._Lambda_18, Types._Bag,
			3, new DomainTypeParameters(TypeParameters.__Bag__collect_V), org.eclipse.ocl.examples.library.iterator.CollectIteration.INSTANCE);
		public static final @NonNull ExecutorOperation _Bag__collectNested = new ExecutorOperation("collectNested", Parameters._Lambda_14, Types._Bag,
			4, new DomainTypeParameters(TypeParameters.__Bag__collectNested_V), org.eclipse.ocl.examples.library.iterator.CollectNestedIteration.INSTANCE);
		...
		public static final @NonNull ExecutorOperation _Bag__flatten = new ExecutorOperation("flatten", Parameters._, Types._Bag,
			6, new DomainTypeParameters(TypeParameters.__Bag__flatten_T2), org.eclipse.ocl.examples.library.collection.CollectionFlattenOperation.INSTANCE);
		public static final @NonNull ExecutorOperation _Bag__including = new ExecutorOperation("including", Parameters._T_3, Types._Bag,
			7, DomainTypeParameters.EMPTY_LIST, org.eclipse.ocl.examples.library.collection.CollectionIncludingOperation.INSTANCE);
		public static final @NonNull ExecutorOperation _Bag__0_intersection = new ExecutorOperation("intersection", Parameters._Collection_3, Types._Bag,
		...
		public static final @NonNull ExecutorOperation _Bag__reject = new ExecutorOperation("reject", Parameters._Lambda_3, Types._Bag,
			10, DomainTypeParameters.EMPTY_LIST, org.eclipse.ocl.examples.library.iterator.RejectIteration.INSTANCE);
		public static final @NonNull ExecutorOperation _Bag__select = new ExecutorOperation("select", Parameters._Lambda_3, Types._Bag,
			11, DomainTypeParameters.EMPTY_LIST, org.eclipse.ocl.examples.library.iterator.SelectIteration.INSTANCE);
		public static final @NonNull ExecutorOperation _Bag__selectByKind = new ExecutorOperation("selectByKind", Parameters._Metaclass_16, Types._Bag,
			12, new DomainTypeParameters(TypeParameters.__Bag__selectByKind_TT), org.eclipse.ocl.examples.library.collection.CollectionSelectByKindOperation.INSTANCE);
		public static final @NonNull ExecutorOperation _Bag__selectByType = new ExecutorOperation("selectByType", Parameters._Metaclass_1, Types._Bag,
			13, new DomainTypeParameters(TypeParameters.__Bag__selectByType_TT), org.eclipse.ocl.examples.library.collection.CollectionSelectByTypeOperation.INSTANCE);
		public static final @NonNull ExecutorOperation _Bag__sortedBy = new ExecutorOperation("sortedBy", Parameters._Lambda_12, Types._Bag,
			14, DomainTypeParameters.EMPTY_LIST, org.eclipse.ocl.examples.library.iterator.SortedByIteration.INSTANCE);
		public static final @NonNull ExecutorOperation _Bag__0_union = new ExecutorOperation("union", Parameters._Collection_3, Types._Bag,
		...
		public static final @NonNull ExecutorOperation _Collection___eq_ = new ExecutorOperation("=", Parameters._OclSelf, Types._Collection,
			1, DomainTypeParameters.EMPTY_LIST, org.eclipse.ocl.examples.library.oclany.OclAnyEqualOperation.INSTANCE);
		public static final @NonNull ExecutorOperation _Collection__any = new ExecutorOperation("any", Parameters._Lambda_19, Types._Collection,
		...
		public static final @NonNull ExecutorOperation _Collection__collect = new ExecutorOperation("collect", Parameters._Lambda_8, Types._Collection,
			7, new DomainTypeParameters(TypeParameters.__Collection__collect_V), org.eclipse.ocl.examples.library.iterator.CollectIteration.INSTANCE);
		public static final @NonNull ExecutorOperation _Collection__collectNested = new ExecutorOperation("collectNested", Parameters._Lambda_7, Types._Collection,
			8, new DomainTypeParameters(TypeParameters.__Collection__collectNested_V), org.eclipse.ocl.examples.library.iterator.CollectNestedIteration.INSTANCE);
		...
		public static final @NonNull ExecutorOperation _Collection__excludesAll = new ExecutorOperation("excludesAll", Parameters._Collection_2, Types._Collection,
			11, new DomainTypeParameters(TypeParameters.__Collection__excludesAll_T2), org.eclipse.ocl.examples.library.collection.CollectionExcludesAllOperation.INSTANCE);
		...
		public static final @NonNull ExecutorOperation _Collection__1_exists = new ExecutorOperation("exists", Parameters._Lambda_19, Types._Collection,
			13, DomainTypeParameters.EMPTY_LIST, org.eclipse.ocl.examples.library.iterator.ExistsIteration.INSTANCE);
		public static final @NonNull ExecutorOperation _Collection__0_exists = new ExecutorOperation("exists", Parameters._Lambda_19, Types._Collection,
		...
		public static final @NonNull ExecutorOperation _Collection__flatten = new ExecutorOperation("flatten", Parameters._, Types._Collection,
			15, new DomainTypeParameters(TypeParameters.__Collection__flatten_T2), org.eclipse.ocl.examples.library.collection.CollectionFlattenOperation.INSTANCE);
		public static final @NonNull ExecutorOperation _Collection__1_forAll = new ExecutorOperation("forAll", Parameters._Lambda_19, Types._Collection,
			16, DomainTypeParameters.EMPTY_LIST, org.eclipse.ocl.examples.library.iterator.ForAllIteration.INSTANCE);
		public static final @NonNull ExecutorOperation _Collection__0_forAll = new ExecutorOperation("forAll", Parameters._Lambda_19, Types._Collection,
		...
		public static final @NonNull ExecutorOperation _Collection__includesAll = new ExecutorOperation("includesAll", Parameters._Collection_1, Types._Collection,
			19, new DomainTypeParameters(TypeParameters.__Collection__includesAll_T2), org.eclipse.ocl.examples.library.collection.CollectionIncludesAllOperation.INSTANCE);
		...
		public static final @NonNull ExecutorOperation _Collection__isUnique = new ExecutorOperation("isUnique", Parameters._Lambda_1, Types._Collection,
		...
		public static final @NonNull ExecutorOperation _Collection__iterate = new ExecutorOperation("iterate", Parameters._Lambda_2, Types._Collection,
			23, new DomainTypeParameters(TypeParameters.__Collection__iterate_Tacc), org.eclipse.ocl.examples.library.iterator.IterateIteration.INSTANCE);
		...
		public static final @NonNull ExecutorOperation _Collection__one = new ExecutorOperation("one", Parameters._Lambda_19, Types._Collection,
			27, DomainTypeParameters.EMPTY_LIST, org.eclipse.ocl.examples.library.iterator.OneIteration.INSTANCE);
		public static final @NonNull ExecutorOperation _Collection__product = new ExecutorOperation("product", Parameters._Collection_6, Types._Collection,
			28, new DomainTypeParameters(TypeParameters.__Collection__product_T2), org.eclipse.ocl.examples.library.collection.CollectionProductOperation.INSTANCE);
		public static final @NonNull ExecutorOperation _Collection__reject = new ExecutorOperation("reject", Parameters._Lambda_19, Types._Collection,
			29, DomainTypeParameters.EMPTY_LIST, org.eclipse.ocl.examples.library.iterator.RejectIteration.INSTANCE);
		public static final @NonNull ExecutorOperation _Collection__select = new ExecutorOperation("select", Parameters._Lambda_19, Types._Collection,
			30, DomainTypeParameters.EMPTY_LIST, org.eclipse.ocl.examples.library.iterator.SelectIteration.INSTANCE);
		public static final @NonNull ExecutorOperation _Collection__selectByKind = new ExecutorOperation("selectByKind", Parameters._Metaclass_15, Types._Collection,
			31, new DomainTypeParameters(TypeParameters.__Collection__selectByKind_TT), org.eclipse.ocl.examples.library.collection.CollectionSelectByKindOperation.INSTANCE);
		public static final @NonNull ExecutorOperation _Collection__selectByType = new ExecutorOperation("selectByType", Parameters._Metaclass_7, Types._Collection,
			32, new DomainTypeParameters(TypeParameters.__Collection__selectByType_TT), org.eclipse.ocl.examples.library.collection.CollectionSelectByTypeOperation.INSTANCE);
		...
		public static final @NonNull ExecutorOperation _Collection__sortedBy = new ExecutorOperation("sortedBy", Parameters._Lambda_1, Types._Collection,
		...
		public static final @NonNull ExecutorOperation _OclAny__oclAsType = new ExecutorOperation("oclAsType", Parameters._Metaclass_9, Types._OclAny,
			3, new DomainTypeParameters(TypeParameters.__OclAny__oclAsType_TT), org.eclipse.ocl.examples.library.oclany.OclAnyOclAsTypeOperation.INSTANCE);
		...
		public static final @NonNull ExecutorOperation _OclAny__oclIsKindOf = new ExecutorOperation("oclIsKindOf", Parameters._Metaclass_6, Types._OclAny,
			6, new DomainTypeParameters(TypeParameters.__OclAny__oclIsKindOf_T), org.eclipse.ocl.examples.library.oclany.OclAnyOclIsKindOfOperation.INSTANCE);
		...
		public static final @NonNull ExecutorOperation _OclAny__oclIsTypeOf = new ExecutorOperation("oclIsTypeOf", Parameters._Metaclass, Types._OclAny,
			8, new DomainTypeParameters(TypeParameters.__OclAny__oclIsTypeOf_T), org.eclipse.ocl.examples.library.oclany.OclAnyOclIsTypeOfOperation.INSTANCE);
		...
		public static final @NonNull ExecutorOperation _OclInvalid__oclAsType = new ExecutorOperation("oclAsType", Parameters._Metaclass_2, Types._OclInvalid,
			7, new DomainTypeParameters(TypeParameters.__OclInvalid__oclAsType_TT), org.eclipse.ocl.examples.library.oclany.OclAnyOclAsTypeOperation.INSTANCE);
		...
		public static final @NonNull ExecutorOperation _OclInvalid__oclIsKindOf = new ExecutorOperation("oclIsKindOf", Parameters._Metaclass_5, Types._OclInvalid,
			9, new DomainTypeParameters(TypeParameters.__OclInvalid__oclIsKindOf_T), org.eclipse.ocl.examples.library.oclany.OclAnyOclIsKindOfOperation.INSTANCE);
		public static final @NonNull ExecutorOperation _OclInvalid__oclIsTypeOf = new ExecutorOperation("oclIsTypeOf", Parameters._Metaclass_3, Types._OclInvalid,
			10, new DomainTypeParameters(TypeParameters.__OclInvalid__oclIsTypeOf_T), org.eclipse.ocl.examples.library.oclany.OclAnyOclIsTypeOfOperation.INSTANCE);
		...
		public static final @NonNull ExecutorOperation _OrderedSet___sub_ = new ExecutorOperation("-", Parameters._UniqueCollection, Types._OrderedSet,
		...
		public static final @NonNull ExecutorOperation _OrderedSet__flatten = new ExecutorOperation("flatten", Parameters._, Types._OrderedSet,
			5, new DomainTypeParameters(TypeParameters.__OrderedSet__flatten_T2), org.eclipse.ocl.examples.library.collection.CollectionFlattenOperation.INSTANCE);
		...
		public static final @NonNull ExecutorOperation _OrderedSet__intersection = new ExecutorOperation("intersection", Parameters._Collection_4, Types._OrderedSet,
			8, DomainTypeParameters.EMPTY_LIST, org.eclipse.ocl.examples.library.collection.CollectionIntersectionOperation.INSTANCE);
		...
		public static final @NonNull ExecutorOperation _OrderedSet__reject = new ExecutorOperation("reject", Parameters._Lambda_6, Types._OrderedSet,
			10, DomainTypeParameters.EMPTY_LIST, org.eclipse.ocl.examples.library.iterator.RejectIteration.INSTANCE);
		...
		public static final @NonNull ExecutorOperation _OrderedSet__select = new ExecutorOperation("select", Parameters._Lambda_6, Types._OrderedSet,
			12, DomainTypeParameters.EMPTY_LIST, org.eclipse.ocl.examples.library.iterator.SelectIteration.INSTANCE);
		public static final @NonNull ExecutorOperation _OrderedSet__selectByKind = new ExecutorOperation("selectByKind", Parameters._Metaclass_10, Types._OrderedSet,
			13, new DomainTypeParameters(TypeParameters.__OrderedSet__selectByKind_TT), org.eclipse.ocl.examples.library.collection.CollectionSelectByKindOperation.INSTANCE);
		public static final @NonNull ExecutorOperation _OrderedSet__selectByType = new ExecutorOperation("selectByType", Parameters._Metaclass_8, Types._OrderedSet,
			14, new DomainTypeParameters(TypeParameters.__OrderedSet__selectByType_TT), org.eclipse.ocl.examples.library.collection.CollectionSelectByTypeOperation.INSTANCE);
		public static final @NonNull ExecutorOperation _OrderedSet__sortedBy = new ExecutorOperation("sortedBy", Parameters._Lambda_9, Types._OrderedSet,
		...
		public static final @NonNull ExecutorOperation _Sequence__closure = new ExecutorOperation("closure", Parameters._Lambda_16, Types._Sequence,
			4, DomainTypeParameters.EMPTY_LIST, org.eclipse.ocl.examples.library.iterator.ClosureIteration.INSTANCE);
		public static final @NonNull ExecutorOperation _Sequence__collect = new ExecutorOperation("collect", Parameters._Lambda_5, Types._Sequence,
		...
		public static final @NonNull ExecutorOperation _Sequence__collectNested = new ExecutorOperation("collectNested", Parameters._Lambda_15, Types._Sequence,
		...
		public static final @NonNull ExecutorOperation _Sequence__0_intersection = new ExecutorOperation("intersection", Parameters._Collection_5, Types._Sequence,
		...
		public static final @NonNull ExecutorOperation _Sequence__selectByKind = new ExecutorOperation("selectByKind", Parameters._Metaclass_12, Types._Sequence,
			20, new DomainTypeParameters(TypeParameters.__Sequence__selectByKind_TT), org.eclipse.ocl.examples.library.collection.CollectionSelectByKindOperation.INSTANCE);
		public static final @NonNull ExecutorOperation _Sequence__selectByType = new ExecutorOperation("selectByType", Parameters._Metaclass_14, Types._Sequence,
			21, new DomainTypeParameters(TypeParameters.__Sequence__selectByType_TT), org.eclipse.ocl.examples.library.collection.CollectionSelectByTypeOperation.INSTANCE);
		public static final @NonNull ExecutorOperation _Sequence__sortedBy = new ExecutorOperation("sortedBy", Parameters._Lambda_10, Types._Sequence,
		...
		public static final @NonNull ExecutorOperation _Set___sub_ = new ExecutorOperation("-", Parameters._UniqueCollection, Types._Set,
			0, DomainTypeParameters.EMPTY_LIST, org.eclipse.ocl.examples.library.collection.SetMinusOperation.INSTANCE);
		...
		public static final @NonNull ExecutorOperation _Set__flatten = new ExecutorOperation("flatten", Parameters._, Types._Set,
			4, new DomainTypeParameters(TypeParameters.__Set__flatten_T2), org.eclipse.ocl.examples.library.collection.CollectionFlattenOperation.INSTANCE);
		...
		public static final @NonNull ExecutorOperation _Set__intersection = new ExecutorOperation("intersection", Parameters._Collection_7, Types._Set,
		...
		public static final @NonNull ExecutorOperation _Set__selectByKind = new ExecutorOperation("selectByKind", Parameters._Metaclass_11, Types._Set,
			9, new DomainTypeParameters(TypeParameters.__Set__selectByKind_TT), org.eclipse.ocl.examples.library.collection.CollectionSelectByKindOperation.INSTANCE);
		public static final @NonNull ExecutorOperation _Set__selectByType = new ExecutorOperation("selectByType", Parameters._Metaclass_13, Types._Set,
			10, new DomainTypeParameters(TypeParameters.__Set__selectByType_TT), org.eclipse.ocl.examples.library.collection.CollectionSelectByTypeOperation.INSTANCE);
		public static final @NonNull ExecutorOperation _Set__sortedBy = new ExecutorOperation("sortedBy", Parameters._Lambda_4, Types._Set,
			11, DomainTypeParameters.EMPTY_LIST, org.eclipse.ocl.examples.library.iterator.SortedByIteration.INSTANCE);
		public static final @NonNull ExecutorOperation _Set__union = new ExecutorOperation("union", Parameters._Collection_7, Types._Set,
		...
		public static final @NonNull ExecutorOperation _UniqueCollection___sub_ = new ExecutorOperation("-", Parameters._UniqueCollection, Types._UniqueCollection,
			0, DomainTypeParameters.EMPTY_LIST, org.eclipse.ocl.examples.library.collection.SetMinusOperation.INSTANCE);
		public static final @NonNull ExecutorOperation _UniqueCollection__sortedBy = new ExecutorOperation("sortedBy", Parameters._Lambda, Types._UniqueCollection,
			1, DomainTypeParameters.EMPTY_LIST, org.eclipse.ocl.examples.library.iterator.SortedByIteration.INSTANCE);
		public static final @NonNull ExecutorOperation _UniqueCollection__symmetricDifference = new ExecutorOperation("symmetricDifference", Parameters._UniqueCollection, Types._UniqueCollection,
			2, DomainTypeParameters.EMPTY_LIST, org.eclipse.ocl.examples.library.collection.SetSymmetricDifferenceOperation.INSTANCE);
		public static final @NonNull ExecutorOperation _UniqueCollection__union = new ExecutorOperation("union", Parameters._Collection, Types._UniqueCollection,
		...
		public static final @NonNull ExecutorOperation _UnlimitedNatural__oclAsType = new ExecutorOperation("oclAsType", Parameters._Metaclass_4, Types._UnlimitedNatural,
			0, new DomainTypeParameters(TypeParameters.__UnlimitedNatural__oclAsType_TT), org.eclipse.ocl.examples.library.numeric.UnlimitedNaturalOclAsTypeOperation.INSTANCE);
	}
