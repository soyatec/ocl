...
import org.eclipse.ocl.examples.xtext.base.util.BaseCSTAutoContainmentVisitor;
...
public class EssentialOCLCSTAutoContainmentVisitor
	extends BaseCSTAutoContainmentVisitor
	implements EssentialOCLCSVisitor<Continuation<?>>
{
     ...
     */
    public EssentialOCLCSTAutoContainmentVisitor(@NonNull CS2PivotConversion context) {
        super(context);
