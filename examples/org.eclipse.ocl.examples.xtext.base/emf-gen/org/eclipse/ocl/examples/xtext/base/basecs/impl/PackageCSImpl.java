 ...
 *   <li>{@link org.eclipse.ocl.examples.xtext.base.basecs.impl.PackageCSImpl#getOwnedNestedPackage <em>Owned Nested Package</em>}</li>
...
public class PackageCSImpl extends NamedElementCSImpl implements PackageCS {
	...
	public EList<PackageCS> getOwnedNestedPackage()
	{
		...
		{
			ownedNestedPackage = new EObjectContainmentEList<PackageCS>(PackageCS.class, this, BaseCSPackage.PACKAGE_CS__OWNED_NESTED_PACKAGE);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID)
		{
			...
			case BaseCSPackage.PACKAGE_CS__OWNED_NESTED_PACKAGE:
